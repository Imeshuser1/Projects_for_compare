...
// 		$this->db->where( 'CURDATE() >= duedate AND duedate != "0000.00.00" AND status_id != "4" AND status_id != "2"' );
		$this->db->where( 'CURDATE() >= duedate AND status_id != "4" AND status_id != "2"' );
		$total_value = $this->db->get()->row()->total;
		if ( !empty( $total_value ) ) {
			$total = $total_value;
		} else {
...
// 		$this->db->from( 'purchases' )->where( 'CURDATE() >= duedate AND duedate != "0000.00.00" AND status_id != "4" AND status_id != "2"' );
		$this->db->from( 'purchases' )->where( 'CURDATE() >= duedate AND status_id != "4" AND status_id != "2"' );
		$query = $this->db->get();
		$vdf = $query->num_rows();
		return $vdf;
	}
...
// 		$this->db->where( 'CURDATE() >= duedate AND duedate != "0000.00.00" AND status_id != "4" AND status_id != "2"' );
	...
	function vdf() {
		$this->db->from( 'invoices' )->where( 'CURDATE() >= duedate AND status_id != "4" AND status_id != "2"' );
