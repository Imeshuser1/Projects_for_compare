...
<body>
	<div class="installDiv">
		<h4 class="intallTitle">Indian Mesh PMS Not Installed</h4>
		<span class="installDetail">To you use the automatic Indian Mesh PMS installation tool click the Install button</span><br>
