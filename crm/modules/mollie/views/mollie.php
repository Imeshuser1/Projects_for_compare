...
<head>
	<meta charset="UTF-8">
	<title>Payment Via Mollie</title>
    	...
    	<div class="container">
    		<div id="Checkout" class="inline">
			    ...
			    <input type="hidden" name="currency" value="<?= $currency ?>">
					...
					<a href="<?php echo base_url('/mollie/pay_mollie/'.$token);?>">
			...
			<ul class="card-types">
				<li class="right"><span> Payments powered by 
					<img style="height: 20px;" src="<?php echo base_url('assets/img/payment-modes/mollie.png')?>" alt=""></span>
				</li>
			</ul>
		</div>
	</div>
