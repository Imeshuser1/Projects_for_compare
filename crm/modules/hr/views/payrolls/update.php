  ...
  <div class="main-content container-fluid col-xs-12 col-md-12 col-lg-9">
    <md-toolbar class="toolbar-white" ng-cloak>
      <div class="md-toolbar-tools">
        ...
        <h2 flex md-truncate><?php echo lang('update') . ' ' . lang('payroll') ?></h2>
        <md-switch ng-model="payroll.payroll_recurring" aria-label="Recurring"> <strong class="text-muted"><?php echo lang('recurring') ?></strong> </md-switch>
    ...
    <md-content class="bg-white" layout-padding ng-cloak>
      <div layout-gt-xs="row">
        <md-input-container class="md-block" flex-gt-sm>
          ...
          <md-select ng-model="payroll.payroll_relation_id" data-md-container-class="selectdemoSelectHeader">
            <md-option ng-value="member.id" ng-repeat="member in staff">{{member.name}}
            </md-option>
          </md-select>
        </md-input-container>
        <md-input-container class="md-block" flex-gt-sm>
          <label><?php echo lang('expense') . ' ' . lang('category'); ?></label>
          <md-select placeholder="<?php echo lang('expense') . ' ' . lang('category'); ?>" ng-model="payroll.payroll_expense_category" name="expense_categories" style="min-width: 200px;">
        ...
        <md-input-container>
          ...
          <md-datepicker name="startdate" ng-model="payroll.payroll_start_date" md-open-on-focus></md-datepicker>
        </md-input-container>
      </div>
      <div layout-gt-xs="row">
        ...
        <md-input-container class="md-block" flex-gt-xs>
          ...
          <input type="number" ng-model="payroll.payroll_base_salary" name="payroll_base_salary">
        </md-input-container>
        <md-input-container class="md-block" flex-gt-xs>
          <label><?php echo lang('paidcashornank'); ?></label>
          <md-select placeholder="<?php echo lang('choiseaccount'); ?>" ng-model="payroll.payroll_account" name="payroll_account" style="min-width: 200px;">
        ...
        <md-input-container>
          ...
          <md-select ng-model="payroll.payroll_run_day" placeholder="<?php echo lang('dayofmonth') ?>">
            <md-option ng-value="run_day" ng-repeat="run_day in run_days">{{run_day}}</md-option>
          </md-select>
        </md-input-container>
        <md-input-container>
          <label><?php echo lang('end') . ' ' . lang('date') ?></label>
          <md-datepicker name="enddate" ng-model="payroll.payroll_end_date" md-open-on-focus></md-datepicker>
        </md-input-container>
      </div>
      <div layout-gt-xs="row">
        <md-input-container class="md-block" flex-gt-sm>
          <label><?php echo lang('payrollnote') ?></label>
          <input ng-model="payroll.payroll_note" name="payrollnote">
        </md-input-container>
      </div>
          ...
          <md-list-item ng-repeat="allowance in payroll.allowances">
            <div layout-gt-sm="row">
              <md-input-container class="md-block">
                ...
                <input class="min_input_width" ng-model="allowance.payroll_item_name">
              </md-input-container>
              <md-input-container>
                <label><?php echo lang('description'); ?></label>
                <textarea class="min_input_width" ng-model="allowance.payroll_item_description" placeholder="<?php echo lang('description'); ?>"></textarea>
              </md-input-container>
              <md-input-container>
                <label><?php echo lang('type'); ?></label>
                <md-select ng-model="allowance.payroll_item_time">
              ...
              <md-input-container class="md-block" flex-gt-sm>
                ...
                <input class="min_input_width" ng-model="allowance.payroll_item_quantity">
              </md-input-container>
              <md-input-container class="md-block">
                <label><?php echo lang('price'); ?></label>
                <input class="min_input_width" ng-model="allowance.payroll_item_price">
              </md-input-container>
              <md-input-container class="md-block">
                <label><?php echo lang('total'); ?></label>
                <input class="min_input_width" ng-value="allowance.payroll_item_quantity * allowance.payroll_item_price * allowance.payroll_item_time">
              </md-input-container>
            </div>
        ...
        <md-content class="bg-white" layout-padding ng-cloak>
          <md-list-item ng-repeat="deduction in payroll.deductions">
            <div layout-gt-sm="row">
              <md-input-container class="md-block">
                <label><?php echo lang('name'); ?></label>
                <input class="min_input_width" ng-model="deduction.payroll_item_name">
              </md-input-container>
              <md-input-container>
                <label><?php echo lang('description'); ?></label>
                <textarea class="min_input_width" ng-model="deduction.payroll_item_description" placeholder="<?php echo lang('description'); ?>"></textarea>
              </md-input-container>
              <md-input-container>
                <label><?php echo lang('type'); ?></label>
                <md-select ng-model="deduction.payroll_item_time">
                  <md-option ng-value="30"><?= lang('daily');?></md-option>
                  <md-option ng-value="1"><?= lang('monthly');?></md-option>
                </md-select>
              </md-input-container>
              <md-input-container class="md-block" flex-gt-sm>
                <label><?php echo lang('quantity'); ?></label>
                <input class="min_input_width" ng-model="deduction.payroll_item_quantity">
              </md-input-container>
              <md-input-container class="md-block">
                <label><?php echo lang('price'); ?></label>
                <input class="min_input_width" ng-model="deduction.payroll_item_price">
              </md-input-container>
              <md-input-container class="md-block">
                <label><?php echo lang('total'); ?></label>
                <input class="min_input_width" ng-value="deduction.payroll_item_quantity * deduction.payroll_item_price * deduction.payroll_item_time">
              </md-input-container>
            </div>
