    ...
    <div class="main-content container-fluid col-xs-12 col-md-12 col-lg-9">
      ...
      <md-toolbar class="toolbar-white">
        <div class="md-toolbar-tools">
          ...
          <?php if (check_privilege('payrolls', 'create')) { ?>
            <md-button ng-href="<?php echo base_url('hr/payrolls/create') ?>" class="md-icon-button" aria-label="New" ng-cloak>
          ...
          <table md-table md-progress="promise">
            <thead md-head md-order="payroll_list.order">
              <tr md-row>
                ...
                <th md-column md-order-by="payroll_staff_name"><span><?php echo lang('staff') . ' ' . lang('name'); ?></span></th>
                <th md-column md-order-by="payroll_start_date_stamp"><span><?php echo lang('start_date'); ?></span></th>
                <th md-column md-order-by="payroll_end_date_stamp"><span><?php echo lang('end_date'); ?></span></th>
                <th md-column md-order-by="payroll_base_salary_float"><span><?php echo lang('base_salary'); ?></span></th>
                <th md-column md-order-by="payroll_grand_total_float"><span><?php echo lang('grand_total'); ?></span></th>
              </tr>
            </thead>
            <tbody md-body>
              <tr class="select_row" md-row ng-repeat="payroll in payrolls | orderBy: payroll_list.order | limitTo: payroll_list.limit : (payroll_list.page -1) * payroll_list.limit | filter: payroll_search | filter: FilteredData" class="cursor">
                <td md-cell>
                  <strong>
                    <a class="link" ng-href="<?php echo base_url('hr/payrolls/payroll/') ?>{{payroll.payroll_id}}"> <span ng-bind="payroll.payroll_number"></span></a>
                  </strong><br>
                </td>
                <td md-cell>
                ...
                <td md-cell>
                  <strong><span ng-bind="payroll.payroll_grand_total"></span></strong>
                </td>
              </tr>
            </tbody>
          </table>
