...
class Quotes extends AREA_Controller {
	...
	function create() {
		...
		if ( isset( $_POST ) && count( $_POST ) > 0 ) {
			...
			$this->form_validation->set_rules('details', lang('details'), 'trim|required|max_length[4294967295]');
			$data['message'] = '';
			if ($this->form_validation->run() == false) {
				...
				$params = array(
					...
					'relation_type' => 'customer',
					'relation' => $this->session->customer,
