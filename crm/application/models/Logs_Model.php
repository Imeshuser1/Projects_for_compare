...
class Logs_Model extends CI_Model {
	...
	function customer_logs( $id ) {
		$this->db->order_by( "date", "desc" );
		return $this->db->get_where( 'logs', array( 'logs.customer_id' => $id ) )->result_array();
	}
// vendor logs 
	function vendor_logs( $id ) {
		$this->db->order_by( "date", "desc" );
		return $this->db->get_where( 'logs', array( 'logs.vendor_id' => $id ) )->result_array();
	}
}