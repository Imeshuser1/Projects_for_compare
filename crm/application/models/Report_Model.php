...
class Report_Model extends CI_Model {
	...
	function invoice_chart_by_status() {
		$statuslar = $this->db->get( 'invoicestatus')->result_array();
		$colors = ciuis_colors();
		$graphic = array(
			'labels' => array(),
			'datasets' => array()
	...
	function get_all_invoices() {
		...
		/*** Get Current Year Invoices ***/
			...
			$this->db->from('invoices')->where('YEAR(invoices.created)', date('Y'));
			return $this->db->get()->result_array();
		} 
		/*** Get Current Month Invoices ***/
		else if ( $period == '2') {
			$this->db->from('invoices')->where('MONTH(invoices.created)', date('m'));
			return $this->db->get()->result_array();
		} 
	...
	function get_all_customers() {
		...
		/*** Get Current Year Customers ***/
			...
			$this->db->from('customers')->where('YEAR(customers.created)', date('Y'));
			return $this->db->get()->result_array();
		} 
		/*** Get Current Month Customers ***/
		else if ( $period == '2') {
			$this->db->from('customers')->where('MONTH(customers.created)', date('m'));
			return $this->db->get()->result_array();
		} 
	...
	function get_all_expenses() {
		...
		/*** Get Current Year Expenses ***/
			...
			$this->db->from('expenses')->where('YEAR(expenses.created)', date('Y'));
			return $this->db->get()->result_array();
		} 
		/*** Get Current Month Expenses ***/
		else if ( $period == '2') {
			$this->db->from('expenses')->where('MONTH(expenses.created)', date('m'));
			return $this->db->get()->result_array();
		} 
	...
	function get_all_proposals() {
		...
		/*** Get Current Year Proposals ***/
			...
			$this->db->from('proposals')->where('YEAR(proposals.created)', date('Y'));
			return $this->db->get()->result_array();
		} 
		/*** Get Current Month Proposals ***/
		else if ( $period == '2') {
			$this->db->from('proposals')->where('MONTH(proposals.created)', date('m'));
			return $this->db->get()->result_array();
		} 
	...
	function get_all_deposits() { 
		...
		/*** Get Current Year Deposits ***/
			...
			$this->db->from('deposits')->where('YEAR(deposits.created)', date('Y'));
			return $this->db->get()->result_array();
		} 
		/*** Get Current Month Deposits ***/
		else if ( $period == '2') {
			$this->db->from('deposits')->where('MONTH(deposits.created)', date('m'));
			return $this->db->get()->result_array();
		} 
	...
	function get_all_orders() {
		...
		/*** Get Current Year Orders ***/
			...
			$this->db->from('orders')->where('YEAR(orders.created)', date('Y'));
			return $this->db->get()->result_array();
		} 
		/*** Get Current Month Orders ***/
		else if ( $period == '2') {
			$this->db->from('orders')->where('MONTH(orders.created)', date('m'));
			return $this->db->get()->result_array();
		} 
	...
	function get_all_vendors() {
		...
		/*** Get Current Year Vendors ***/
			...
			$this->db->from('vendors')->where('YEAR(vendors.created)', date('Y'));
			return $this->db->get()->result_array();
		} 
		/*** Get Current Month Vendors ***/
		else if ( $period == '2') {
			$this->db->from('vendors')->where('MONTH(vendors.created)', date('m'));
			return $this->db->get()->result_array();
		} 
	...
	function get_all_purchases() {
		...
		/*** Get Current Year Purchases ***/
			...
			$this->db->from('purchases')->where('YEAR(purchases.created)', date('Y'));
			return $this->db->get()->result_array();
		} 
		/*** Get Current Month Purchases ***/
		else if ( $period == '2') {
			$this->db->from('purchases')->where('MONTH(purchases.created)', date('m'));
			return $this->db->get()->result_array();
		} 
	...
	function get_all_contacts() {
		...
		/*** Get Current Year Contacts ***/
			...
			$this->db->from('contacts')->where('YEAR(created)', date('Y'));
			return $this->db->get()->result_array();
		} 
		/*** Get Current Month Contacts ***/
		else if ( $period == '2') {
			$this->db->from('contacts')->where('MONTH(created)', date('m'));
			return $this->db->get()->result_array();
		} 
	...
	function get_all_tickets() {
		...
		/*** Get Current Year Tickets ***/
			...
			$this->db->from('tickets')->where('YEAR(tickets.date)', date('Y'));
			return $this->db->get()->result_array();
		} 
		/*** Get Current Month Tickets ***/
		else if ( $period == '2') {
			$this->db->from('tickets')->where('MONTH(tickets.date)', date('m'));
			return $this->db->get()->result_array();
		} 
	...
	function get_all_tasks() {
		...
		/*** Get Current Year Tasks ***/
			...
			$this->db->from('tasks')->where('YEAR(tasks.created)', date('Y'));
			return $this->db->get()->result_array();
		} 
		/*** Get Current Month Tasks ***/
		else if ( $period == '2') {
			$this->db->from('tasks')->where('MONTH(tasks.created)', date('m'));
			return $this->db->get()->result_array();
		} 
	...
	function get_all_leads() {
		...
		/*** Get Current Year Leads ***/
			...
			$this->db->from('leads')->where('YEAR(leads.created)', date('Y'));
			return $this->db->get()->result_array();
		} 
		/*** Get Current Month Leads ***/
		else if ( $period == '2') {
			$this->db->from('leads')->where('MONTH(leads.created)', date('m'));
			return $this->db->get()->result_array();
		} 
	...
	function get_all_products() { 
		...
		/*** Get Current Year Products ***/
			...
			$this->db->from('products')->where('YEAR(products.createdat)', date('Y'));
			return $this->db->get()->result_array();
		} 
		/*** Get Current Month Products ***/
		else if ( $period == '2') {
			$this->db->from('products')->where('MONTH(products.createdat)', date('m'));
			return $this->db->get()->result_array();
		} 
	...
	function get_all_staff() {
		...
		/*** Get Current Year Staff ***/
			...
			$this->db->from('staff')->where('YEAR(staff.createdAt)', date('Y'));
			return $this->db->get()->result_array();
		} 
		/*** Get Current Month Staff ***/
		else if ( $period == '2') {
			$this->db->from('staff')->where('MONTH(staff.createdAt)', date('m'));
			return $this->db->get()->result_array();
		} 
	...
	function get_all_projects() {
		...
		/*** Get Current Year Projects ***/
			...
			$this->db->from('projects')->where('YEAR(projects.created)', date('Y'));
			return $this->db->get()->result_array();
		} 
		/*** Get Current Month Projects ***/
		else if ( $period == '2') {
			$this->db->from('projects')->where('MONTH(projects.created)', date('m'));
			return $this->db->get()->result_array();
		} 
	...
	function get_all_timesheet() {
		$period = $this->input->post('period');
		$from = $this->input->post('from');
		$to = $this->input->post('to');
		$this->db->select( 'tasktimer.id, tasktimer.start, tasktimer.end, tasktimer.task_id, tasks.name, tasks.task_number, tasktimer.note, staff.staffname as staff, staff.id as staff_id, staff.staffavatar as avatar, staff.email as staff_email ' );
		$this->db->join( 'staff', 'tasktimer.staff_id = staff.id', 'left' );
		$this->db->join( 'tasks', 'tasktimer.task_id = tasks.id', 'left' );
		$this->db->order_by('tasktimer.id', 'desc');
		/*** Get All Timesheets ***/
		if($period == '0') {
			return $this->db->get( 'tasktimer' )->result_array();
		} 
		/*** Get Current Year Timesheets ***/
		else if ( $period == '1') {
			$this->db->from('tasktimer')->where('YEAR(tasktimer.start)', date('Y'));
			return $this->db->get()->result_array();
		} 
		/*** Get Current Month Timesheets ***/
		else if ( $period == '2') {
			$this->db->from('tasktimer')->where('MONTH(tasktimer.start)', date('m'));
			return $this->db->get()->result_array();
		} 
		/*** Get Current Week Timesheets ***/
		else if ( $period == '3') {
			$this->db->from('tasktimer')->where( 'WEEK(tasktimer.start) = WEEK(CURRENT_DATE)');
			return $this->db->get()->result_array();
		} 
		/*** Get Last Year Timesheets ***/
		else if ( $period == '4') {
			$this->db->from('tasktimer')->where( 'YEAR(tasktimer.start) = YEAR(CURRENT_DATE - INTERVAL 1 YEAR)');
			return $this->db->get()->result_array();
		} 
		/*** Get Last Month Timesheets ***/
		else if ( $period == '5') {
			$this->db->from('tasktimer')->where( 'MONTH(tasktimer.start) = MONTH(CURRENT_DATE - INTERVAL 1 MONTH)');
			return $this->db->get()->result_array();
		}
		/*** Get Last Week Timesheets ***/
		else if ( $period == '6') {
			$this->db->from('tasktimer')->where( 'WEEK(tasktimer.start) = WEEK(CURRENT_DATE - INTERVAL 1 WEEK)');
			return $this->db->get()->result_array();
		}
		/*** Get Custom Timesheets ***/
		else if ( $period == '7') {
			$this->db->where(array('tasktimer.start>=' => $from, 'tasktimer.start<=' => $to));
			return $this->db->get('tasktimer')->result_array();
		}
	}
	...
	function TimesheetsReport() {
		...
		foreach ( $result as $field ) {
			...
			$timesheet[] = array(
				...
				'end_time' => $field['end'] ? (date(get_dateTimeFormat(), strtotime($field['end']))):null,
				'total_time' => $total,
	...
	function get_items($type, $id) {
		$this->db->select( 'items.*, products.categoryid, products.purchase_price, products.stock' );
		$this->db->join('products', 'products.id = items.product_id', 'left');
		return $this->db->get_where( 'items', array( 'relation_type' => $type, 'relation' => $id ) )->result_array();
	}
}
