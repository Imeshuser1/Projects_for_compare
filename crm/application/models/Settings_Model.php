...
class Settings_Model extends CI_Model {
	...
	function update_settings( $settingname, $params ) {
		...
		$response = $this->db->update('email_templates', array('from_name' => $this->input->post( 'sender_name' )));
	}
	...
	function update_appconfig() {
		...
		$this->db->where('name', 'payroll_series')->update('appconfig', array('value' => $this->input->post('payroll_series')));
		$this->db->where('name', 'payroll_prefix')->update('appconfig', array('value' => $this->input->post('payroll_prefix')));
		$this->db->where('name', 'payslip_series')->update('appconfig', array('value' => $this->input->post('payslip_series')));
		$this->db->where('name', 'payslip_prefix')->update('appconfig', array('value' => $this->input->post('payslip_prefix')));
		$this->db->where('name', 'inventory_series')->update('appconfig', array('value' => $this->input->post('inventory_series')));
		$this->db->where('name', 'inventory_prefix')->update('appconfig', array('value' => $this->input->post('inventory_prefix')));
		$this->db->where('name', 'warehouse_series')->update('appconfig', array('value' => $this->input->post('warehouse_series')));
		$this->db->where('name', 'warehouse_prefix')->update('appconfig', array('value' => $this->input->post('warehouse_prefix')));
	}
