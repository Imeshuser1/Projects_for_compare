				...
				<md-tabs md-dynamic-height md-border-bottom>
					...
					<md-tab label="<?php echo lang('purchases');?>">
                        <md-content class="bg-white">
                            <md-list flex class="md-p-0 sm-p-0 lg-p-0">
                                <md-list-item ng-repeat="purchase in purchases" ng-click="Gopurchases($index)"
                                aria-label="Purchase">
                                <md-icon class="ion-ios-cart-outline"></md-icon>
                                <p><strong ng-bind="purchase.longid"></strong></p>
                                <h4><strong
                                    ng-bind-html="purchase.total | currencyFormat:cur_code:null:true:cur_lct"></strong>
                                </h4>
                                <md-divider></md-divider>
                            </md-list-item>
                        </md-list>
                        <md-content ng-show="!purchases.length" class="md-padding bg-white no-item-data">
					...
					<md-tab label="<?php echo lang('vendoractivities');?>">
						...
						<!--Vendor activity-->
							<li ng-repeat="log_vendor in vendor.vendor_logs">				
									<div class="user-timeline-title" ng-bind="log_vendor.date"></div>
									<div class="user-timeline-description" ng-bind-html="log_vendor.detail|trustAsHtml"></div>
								</li>					
							</ul>
						</md-content>
					</md-tab>
