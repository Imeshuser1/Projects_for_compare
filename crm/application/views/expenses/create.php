  ...
  <div class="main-content container-fluid col-xs-12 col-md-12 col-lg-9">
    <md-toolbar class="toolbar-white">
      <div class="md-toolbar-tools">
        ...
        <h2 flex md-truncate><?php echo lang('newexpense') ?></h2>
    ...
    <md-content ng-show="!expensesLoader" class="bg-white" layout-padding ng-cloak>
      ...
      <div layout-gt-xs="row">
        ...
        <md-input-container>
          ...
          <md-datepicker required name="created" ng-model="newexpense.date"  md-date-locale="locale" md-open-on-focus></md-datepicker>
      ...
      <div ng-show="expense_recurring" layout-gt-xs="row">
        <md-input-container class="md-block" flex-gt-xs>
          ...
          <input type="number" ng-value="1" value="1" ng-init="recurring_period == 1" min="0" ng-model="recurring_period" name="recurring_period">
        </md-input-container>
        <md-input-container class="md-block" flex-gt-xs>
      ...
      <md-list-item ng-repeat="item in newexpense.items">
        ...
        <div layout-gt-sm="row"  class= "total-line">
          ...
          <md-input-container class="md-block" flex-gt-xs>
            ...
            <input type = "number" min ="0"  class="min_input_width" disabled="" ng-value="sub_val(item)">
          </md-input-container>
        </div>
