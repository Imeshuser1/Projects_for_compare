	...
	<div class="container">
		<div class="row">
			<div class="page-header row">
				...
				<div class="col-md-4 col-sm-4 col-xs-4 font" style="padding-top: 2%;">
					<small class="font">
				...
				<div class="col-md-5 col-sm-5 col-xs-5">
					<small class="" style="position:relative;top:20px;right:20px;padding-right: 40px;text-align: left;float: right;">
						<strong><span class="text-uppercase font"><?php echo lang('expense') ?></span> <br><!--  Expense Title in your language -->
							#<span class="font"><?php echo ''.$number.'' ?></span>  <!-- Expense number -->
							<span class="font"><?php echo ''. ($expense['number'] ? "<br>". lang( 'reference' ).':' : '') . $expense['number'] . '' ?></span>
							<br> <!-- Expense reference -->
							<span class="font"><?php echo '' . lang( 'expense' ) .' '.lang( 'date' ). ': ' . date(get_dateFormat(), strtotime($expense['date'])) . '' ?></span> <!-- Expense created date -->
						</strong>
					</small>
				</div>
			</div>
			<div class="col-md-12 nav panel" style="padding-bottom: 20px;box-shadow: unset;padding-right: 0;">
				...
				<?php if ($expense[ 'internal' ] == '1') { ?> 
					<div style="border-bottom: 1px solid #eee;padding-bottom: 10px;">
						<strong class="font"><?php echo lang('internal'). ' '.lang('expense') ?></strong>
					</div>
					<div class="col-md-6 col-sm-6 col-xs-6" style="padding: 0">
				<?php } else { ?>
				<div style="border-bottom: 1px solid #eee;padding-bottom: 10px;">
					<strong lcass="font"><?php echo lang('customer').' '.lang('expense') ?></strong>
				</div>
				<div class="col-md-6 col-sm-6 col-xs-6" style="padding: 0">
					<br>
					<small>
					...
					<small>
						<strong class="font"><?php echo (($expense[ 'customer_taxnum' ] == 0 || !$expense[ 'customer_taxnum' ]) ? '': ($appconfig['tax_label'].' '.lang('vatnumber').': '.$expense[ 'customer_taxnum' ]))  ?></strong>
					</small>
				</div>
			<?php } ?><br>
			</div>
			...
			<div class="col-md-12 col-xs-12 col-sm-12 panel" style="padding:0px;margin-top: 4%;page-break-inside: avoid;">
				<div class="col-md-6 col-xs-6 col-sm-6 panel pull-left" style="padding: 0;padding: 0;border: 1px solid #90909045;border-radius: 4px;width: 55%;page-break-inside: avoid;">
					...
					<table class="table" style="page-break-inside: avoid;">
						<thead style="">
							<tr>
								<th class="col-md-12 font"><?php echo  $expense['account'] ?></th>
							</tr>
						</thead>
					</table>
				</div>
			...
			<div style="padding-bottom: 10px;font-size: 17px;margin-top: 10px;border-top: 1px solid #efefef;border-bottom: 1px solid #dddddd;">
				<strong class="font"><?php echo lang('attached'). ' ' .lang('files') ?></strong>
			</div>
		...
		<?php } ?>
			<?php if (count($images) > 0) { ?>
				<div style="border-bottom: 1px solid #eee;padding-bottom: 10px;margin-bottom: 5%;font-size: 17px;margin-top: 40px;">
					<strong class="font"><?php echo lang('attached'). ' ' .lang('receipts') ?></strong>
				</div>
