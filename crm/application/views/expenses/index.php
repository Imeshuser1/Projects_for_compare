...
<div class="ciuis-body-content" ng-controller="Expenses_Controller">
  <div class="main-content container-fluid col-xs-12 col-md-12 col-lg-12">
    <div class="col-md-9" style="padding: 0px">
          ...
          <md-menu md-position-mode="target-right target">
            ...
            <md-menu-content width="4" ng-cloak>
              <md-contet layout-padding>
                <md-checkbox md-no-ink aria-label="column select" class="md-primary" ng-model="table_columns.title" ng-change="updateColumns('title', table_columns.title);">
                  <?php echo lang('title') ?>
                </md-checkbox><br>
      ...
      <md-content ng-show="!expensesLoader" class="bg-white" ng-cloak> 
                ...
                <th ng-show="table_columns.staff" md-column md-order-by="staff"><span><?php echo lang('staff'); ?></span></th>
								<th ng-show="table_columns.status" md-column md-order-by="billstatus"><span><?php echo lang('status'); ?></span></th>
								<th ng-show="table_columns.total" md-column md-order-by="amount"><span><?php echo lang('amount'); ?></span></th>
							</tr>
						</thead>
						<tbody md-body>
							<tr class="select_row" md-row ng-repeat="expense in expenses | orderBy: expense_list.order | limitTo: expense_list.limit : (expense_list.page -1) * expense_list.limit | filter: expense_search | filter: FilteredData" class="cursor" ng-click="goToLink('expenses/receipt/'+expense.id)">
								<td md-cell>
									...
									<small ng-show="table_columns.title" ng-bind="expense.title"></small>
								</td>
                ...
                <td ng-show="table_columns.customer" md-cell>
                  <strong><span ng-bind="expense.customer"></span></strong>
                </td>
                <td ng-show="table_columns.staff" md-cell>
                  <strong><span ng-bind="expense.staff"></span></strong>
                </td>
  ...
  <md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="ContentFilter"  ng-cloak style="width: 450px;">
    ...
    <md-content layout-padding="" ng-cloak>
      <div ng-repeat="(prop, ignoredValue) in expenses[0]" ng-init="filter[prop]={}" ng-if="prop != 'id' && prop != 'title' && prop != 'prefix' && prop != 'longid' && prop != 'amount' && prop != 'staff' && prop != 'color' && prop != 'displayinvoice' && prop != 'date' && prop != 'category' && prop != 'billstatus' && prop != 'billable' && prop != 'staff' && prop != 'customer'">
