  ...
  <md-content>
    <md-content layout-padding="">
      ...
      <md-input-container class="md-block">
        ...
        <input mdc-datetime-picker="" date="true" format="{{DateTimeFormat}}" time="true" type="text" id="datetime" placeholder="<?php echo lang('chooseadate') ?>" show-todays-date="" minutes="true" min-date="date" show-icon="true" ng-model="expense.date" class=" dtp-no-msclear dtp-input md-input">
      </md-input-container>
