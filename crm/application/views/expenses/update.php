    ...
    <md-content ng-show="!expensesLoader" class="bg-white" layout-padding>
      ...
      <div layout-gt-xs="row">
        ...
        <md-input-container class="md-block">
          ...
          <md-datepicker required name="created" ng-model="expense.date_edit" md-date-locale="locale" md-open-on-focus></md-datepicker>
      ...
      <div ng-show="expense.recurring_status" layout-gt-xs="row">
        <md-input-container class="md-block" flex-gt-xs>
          ...
          <input type="number" min="1"  ng-value="1" value="1" ng-init="recurring_period == 1" ng-model="expense.recurring_period" name="recurring_period">
        </md-input-container>
        <md-input-container class="md-block" flex-gt-xs>
        ...
        <md-input-container>
          ...
          <md-datepicker md-min-date="date" name="end_recurring" ng-model="expense.end_recurring" md-date-locale="locale" style="min-width: 100%;" md-open-on-focus></md-datepicker>
          <div >
      ...
      <md-list-item ng-repeat="item in expense.items">
        <div layout-gt-sm="row">
          ...
          <md-input-container class="md-block" flex-gt-sm>
            ...
            <input type = "number" min ="1" class="min_input_width" ng-model="item.quantity" >
          </md-input-container>
          <md-input-container class="md-block">
          ...
          <md-input-container class="md-block" flex-gt-sm>
            ...
            <input type = "number" min ="0"  class="min_input_width" ng-value="item.tax" ng-model="item.tax">
          ...
          <md-input-container class="md-block">
            ...
            <input type = "number" min ="1" class="min_input_width" disabled="" ng-value="sub_val(item)">
          </md-input-container>
        </div>
