  ...
  <div class="main-content container-fluid col-xs-12 col-md-12 col-lg-9">
    <md-toolbar class="toolbar-white" ng-cloak>
      <div class="md-toolbar-tools">
        ...
        <md-switch ng-model="payroll_recurring" aria-label="Recurring"> <strong
            class="text-muted"><?php echo lang('recurring') ?></strong> </md-switch>
    ...
    <md-content class="bg-white" layout-padding ng-cloak>
      <div layout-gt-xs="row">
        ...
        <md-input-container class="md-block" flex-gt-sm>
          ...
          <md-select placeholder="<?php echo lang('expense').' '.lang('category'); ?>" ng-model="payroll.payroll_expense_category"
            name="expense_categories" style="min-width: 200px;">
      ...
      <div layout-gt-xs="row">
        ...
        <md-input-container class="md-block" flex-gt-xs>
          ...
          <md-select placeholder="<?php echo lang('choiseaccount'); ?>" ng-model="payroll.payroll_account" name="payroll_account"
          ...
          <md-list-item ng-repeat="allowance in payroll.allowances">
            <div layout-gt-sm="row">
              ...
              <md-input-container>
                ...
                <textarea class="min_input_width" ng-model="allowance.payroll_item_description"
              ...
              <md-input-container class="md-block">
                ...
                <input class="min_input_width" ng-value="allowance.payroll_item_quantity * allowance.payroll_item_price">
              </md-input-container>
            </div>
            <md-icon aria-label="Remove Line" ng-click="remove_allowance($index)"
              class="md-secondary ion-trash-b text-muted">
            </md-icon>
          </md-list-item>
          <md-content class="bg-white" layout-padding ng-cloak>
            <div class="col-md-6">
        ...
        <md-content class="bg-white" layout-padding ng-cloak>
          <md-list-item ng-repeat="deduction in payroll.deductions">
            <div layout-gt-sm="row">
              ...
              <md-input-container>
                <label><?php echo lang('description'); ?></label>
                <textarea class="min_input_width" ng-model="deduction.payroll_item_description"
                  placeholder="<?php echo lang('description'); ?>"></textarea>
              </md-input-container>
              <md-input-container class="md-block" flex-gt-sm>
                <label><?php echo lang('quantity'); ?></label>
              ...
              <md-input-container class="md-block">
                <label><?php echo lang('total'); ?></label>
                <input class="min_input_width" ng-value="deduction.payroll_item_quantity * deduction.payroll_item_price">
              </md-input-container>
            </div>
            <md-icon aria-label="Remove Line" ng-click="remove_deduction($index)"
              class="md-secondary ion-trash-b text-muted">
            </md-icon>
          </md-list-item>
          <md-content class="bg-white" layout-padding ng-cloak>
            <div class="col-md-6">
              <md-button ng-click="add_deduction()" class="md-fab pull-left md-hue-2" ng-disabled="false"
                aria-label="Add Line">
                <md-icon class="ion-plus-round text-muted"></md-icon>
              </md-button>
            </div>
