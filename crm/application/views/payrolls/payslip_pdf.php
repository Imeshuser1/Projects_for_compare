...
<?php $staff_number = get_number('staff',$payslip['id'],'staff','staff');?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="row">
			<div class="page-header">
				...
				<small class="pull-right" style="position:relative;top:20px;right:20px;">
					...
					date(get_dateFormat(), strtotime($payslip['payslip_start_date']))?></span> - <span class="font"><?= lang( 'end' )?></span> : <?= date(get_dateFormat(), strtotime($payslip['payslip_end_date']))?> <!-- Invoice created date -->
					</strong>
				</small>
			</div> 
			...
			<div class="col-md-12 nav panel">
				...
				<div class="col-md-6 col-sm-6 col-xs-6 font" style="padding: 0">
					<strong><h3 class="font"><?= lang('allowance') ?></h3></strong>
					<table class="table panel table-border">
				...
				<div class="col-md-6 col-sm-6 col-xs-6 font" style="padding: 0">
					<strong><h3 class="font"><?= lang('deduction') ?></h3></strong>
					<table class="table panel table-border">
						<thead class="thead-dark">
							<tr>
								<th class="font">
