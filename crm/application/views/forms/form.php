...
<div class="ciuis-body-content" ng-controller="WebLead_Controller">
  ...
  <md-dialog-content layout-padding>
    <md-content class="md-padding bg-white">
      ...
      <hr>
      <h4><?php echo lang('custom') . ' ' . lang('css'); ?></h4>
      <md-input-container class="md-block">
            <pre id="ace_custom_css" class="ace_editor_this" style="min-height: 30vh;"></pre>
          <!-- <textarea ng-model="weblead.custom_css" onchange="load_custom_css_preview(this.value);" onkeyup="load_custom_css_preview(this.value);"></textarea> -->
        </md-input-container>
    </md-content>
...
<style id="custom_css_preview"></style>
