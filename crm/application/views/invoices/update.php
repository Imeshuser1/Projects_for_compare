    ...
    <md-content ng-show="!invoiceLoader" class="bg-white" layout-padding ng-cloak>
      <div layout-gt-xs="row">
        ...
        <md-input-container>
          ...
          <md-datepicker name="created" ng-model="invoice.created_edit" md-date-locale="locale" md-open-on-focus></md-datepicker>
        </md-input-container>
      </div>
      <div ng-show="invoice.recurring_status" layout-gt-xs="row">
        ...
        <md-input-container class="md-block" flex-gt-xs>
          ...
          <input type="number" ng-model="invoice.recurring_period" name="recurring_period" min="0">
        </md-input-container>
        <md-input-container class="md-block" flex-gt-xs>
        ...
        <md-input-container>
          ...
          <md-datepicker md-min-date="date" name="recurring_endDate" ng-model="invoice.recurring_endDate" md-date-locale="locale" md-open-on-focus></md-datepicker>
          <div >
      ...
      <div  layout-gt-xs="row">
        ...
        <!-- <md-input-container>
          ...
          <md-datepicker md-min-date="invoice.created_edit" name="duedate" ng-model="invoice.duedate_edit" md-date-locale="locale" md-open-on-focus></md-datepicker>
        </md-input-container> -->
        ...
        <md-input-container>
          <label><?php echo lang('duedate') ?></label>
          <md-datepicker md-min-date="invoice.duedate_edit" name="duedate" ng-model="invoice.duedate_edit" md-date-locale="locale" md-open-on-focus></md-datepicker>
        </md-input-container>
      </div>
    </md-content>
    <md-content ng-show="!invoiceLoader" class="bg-white" layout-padding ng-cloak>
