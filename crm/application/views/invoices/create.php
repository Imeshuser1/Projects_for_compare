    ...
    <md-content ng-show="!invoiceLoader" class="bg-white" layout-padding ng-cloak>
      ...
      <div layout-gt-xs="row">
        ...
        <md-input-container ng-show="!invoice_status">
          ...
          <md-datepicker md-min-date="created" name="duedate" ng-model="duedate" md-date-locale="locale" md-open-on-focus></md-datepicker>
        </md-input-container>
      </div>
      ...
      <md-list-item ng-repeat="item in invoice.items">
        ...
        <div layout-gt-sm="row" class= "total-line">
          ...
          <md-input-container class="md-block" flex-gt-sm>
            ...
            <ng-message ng-show="item.quantity > selectedProduct.stock"><?= lang('limited_stock'); ?></ng-message>
          </md-input-container>
          <md-input-container class="md-block" flex-gt-sm>
