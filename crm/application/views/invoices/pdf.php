		...
		<div class="row">
			<div class="page-header">
				...
				<small class="pull-right" style="position:relative;top:20px;right:20px;">
					<strong class="font">
						<span class="text-uppercase font"><?php echo lang('invoice') ?></span> <br><!--  Invoice Title in your language -->
			...
			<div class="row" style="page-break-inside: avoid;padding-top: 20%;">
				<div class="col-md-12 col-xs-12 col-sm-12 panel" style="padding:0px;border: unset;box-shadow: unset;margin-bottom:unset;">
					...
					<div style="padding: 0;padding: 0;border: 1px solid #90909045;border-radius: 4px;">
						...
						<table class="table" style="page-break-inside: avoid;">
							<thead style="">
								<tr>
									<th class="col-md-2 font"><?php echo  lang( 'date' ) ?></th>
									<th class="col-md-2 font"><?php echo  lang( 'account' ) ?></th>
									<th style="text-align: center;" class="col-md-2 font"><?php echo  lang( 'amount' ) ?></th>
								</tr>
							</thead>
							<tbody>
