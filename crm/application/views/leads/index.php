...
<div class="ciuis-body-content" ng-controller="Leads_Controller" >
  <div class="main-content container-fluid col-xs-12 col-md-12 col-lg-12">
            ...
            <md-menu md-position-mode="target-right target">
              ...
              <md-menu-content width="4" ng-cloak>
                <md-contet layout-padding>
                  ...
                  <md-checkbox md-no-ink aria-label="column select" class="md-primary" ng-model="table_columns.phone" ng-change="updateColumns('phone', table_columns.phone);">
                    <?php echo lang('phone') ?>
                  </md-checkbox><br>
                  ...
                  <md-checkbox md-no-ink aria-label="column select" class="md-primary" ng-model="table_columns.source" ng-change="updateColumns('source', table_columns.source);">
                    <?php echo lang('source'); ?>
                  </md-checkbox><br>
                  <md-checkbox md-no-ink aria-label="column select" class="md-primary" ng-model="table_columns.date_contacted" ng-change="updateColumns('date_connected', table_columns.date_contacted);">
                    <?php echo lang('date_contacted') ?>
                  </md-checkbox><br>
              ...
              <table md-table md-progress="promise">
                <thead md-head md-order="lead_list.order">
                  <tr md-row>
                    ...
                    <th ng-show="table_columns.customer" md-column md-order-by="name"><span><?php echo lang('customer'); ?></span></th>
                    <th ng-show="table_columns.phone" md-column md-order-by="phone"><span><?php echo lang('phone'); ?></span></th>
                    <th ng-show="table_columns.status" md-column md-order-by="statusname"><span><?php echo lang('status'); ?></span></th>
                    <th ng-show="table_columns.value" md-column md-order-by="statusname"><span><?php echo lang('value'); ?></span></th>
                    <th ng-show="table_columns.source" md-column md-order-by="sourcename"><span><?php echo lang('source'); ?></span></th>
                    <th ng-show="table_columns.date_contacted" md-column md-order-by="date_contacted"><span><?php echo lang('date_contacted'); ?></span></th>
                ...
                <tbody md-body>
                  <tr class="select_row" md-row ng-repeat="lead in leads | orderBy: lead_list.order | limitTo: lead_list.limit : (lead_list.page -1) * lead_list.limit | filter: lead_search | filter: FilteredData" class="cursor" ng-click="goToLink('leads/lead/'+lead.id)">
                    <td md-cell>
                      ...
                      <small><span ng-show="table_columns.name" class="blur" ng-bind="lead.name"></span></small>
                    </td>
                    <td ng-show="table_columns.customer" md-cell>
                      <strong><span ng-bind="lead.company"></span></strong><br>
                    </td>
                    <td ng-show="table_columns.phone" md-cell>
                    ...
                    <td ng-show="table_columns.value" md-cell>
                      <md-tooltip md-direction="top" ng-bind="lead.value"></md-tooltip>
                      <md-icon><i class="{{lead.leadclass}}"></i></md-icon>
                    </td>
                    <td ng-show="table_columns.source" md-cell>
                      <strong><span class="badge" ng-bind="lead.sourcename"></span></strong>
                    </td>
                     <td ng-show="table_columns.date_contacted" md-cell>
                      <strong><span class="badge" ng-bind="lead.date_contacted"></span></strong>
                    </td>
                    <td ng-show="table_columns.assigned" md-cell>
                      ...
                      <md-tooltip md-direction="top" ng-bind="lead.assigned"></md-tooltip>
                    </td>
                  </tr>
                </tbody>
              </table>
      ...
      <md-content>
        <md-content layout-padding>
          ...
          <md-input-container class="md-block">
            ...
            <input required mdc-datetime-picker="" date="true" format="{{DateTimeFormat}}" time="true" type="text" id="datetime" placeholder="<?php echo lang('chooseadate') ?>" show-todays-date="" minutes="true" show-icon="true" ng-model="lead.date_contacted" class=" dtp-no-msclear dtp-input md-input">
          </md-input-container>
    ...
    <md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="ContentFilter" ng-cloak style="width: 450px;">
      ...
      <md-content layout-padding="">
        <div ng-repeat="(prop, ignoredValue) in leads[0]" ng-init="filter[prop]={}" ng-if="prop != 'name' && prop != 'id' && prop != 'company' && prop != 'phone' && prop != 'color' && prop != 'status' && prop != 'source' && prop != 'assigned' && prop != 'avatar' && prop != 'staff' && prop != 'createddate' && prop != 'statusname' && prop != 'sourcename' && prop != 'lead_number' && prop != 'email' && prop != 'tags' && prop != 'date_contacted' && prop != 'tagss' && prop != 'leadclass' && prop != 'value'">
    ...
    <md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="Import" ng-cloak style="width: 450px;">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <md-input-container class="md-block">
            <label><?php echo lang('status'); ?></label>
            <md-select placeholder="<?php echo lang('status'); ?>" name="importstatus" ng-model="importstatus" ng-bing style="min-width: 200px;" ng-required>
              <md-option ng-value="status.id" ng-repeat="status in leadstatusnames">{{status.name}}</md-option>
            </md-select>
          </md-input-container>
          <br>
          <md-input-container class="md-block">
