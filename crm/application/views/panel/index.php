...
<?php if ($this->session->tour_status == 1) { ?>
<script>
		...
		setTimeout(function() {
			...
			intro.setOptions({
				steps: [{
					...
					<p class="title"><?= lang('welcome').' '.lang('to').' '.setting['crm_name']?></p>
					<p class="tour-description"><?= lang('welcome_intro'); ?></p></div>`,
					position: 'right',
				},
				<?php if ( $this->Privileges_Model->check_privilege( 'proposals', 'own' ) || $this->Privileges_Model->check_privilege( 'proposals', 'all' ) ) { ?>
					{
				...
				<?php } if ( $this->Privileges_Model->check_privilege( 'orders', 'own' ) || $this->Privileges_Model->check_privilege( 'orders', 'all' ) ) { ?>
					{
						element: document.querySelector('.nav_left_menu > li.nav_left_icon_custom.ion-ios-filing-outline'),
						intro: `<i class="tour ion-ios-filing-outline"></i>
						<img class="icon_close" src="<?= base_url('assets/img/tour/close.png'); ?>" onclick="introJs().exit();">
						<div class="top_container">
						<p class="title"><?= lang('x_menu_orders'); ?></p>
						<p class="tour-description"><?= lang('manage_orders'); ?></p></div>`,
						position: 'right',
					},
				<?php } if ( $this->Privileges_Model->check_privilege( 'invoices', 'own' ) || $this->Privileges_Model->check_privilege( 'invoices', 'all' ) ) { ?>
					{
				...
				<?php } if ( $this->Privileges_Model->check_privilege( 'purchases', 'own' ) || $this->Privileges_Model->check_privilege( 'purchases', 'all' ) ) { ?>
					{
						element: document.querySelector('.nav_left_menu > li.nav_left_icon_custom.ion-ios-cart-outline'),
						intro:  `<i class="tour ion-ios-cart-outline"></i>
						<img class="icon_close" src="<?= base_url('assets/img/tour/close.png'); ?>" onclick="introJs().exit();"><div class="top_container">
						<p class="title"><?= lang('x_menu_purchases'); ?></p>
						<p class="tour-description"><?= lang('manage_purchases'); ?></p></div>`,
						position: 'right',
					},
				<?php } if ( $this->Privileges_Model->check_privilege( 'projects', 'own' ) || $this->Privileges_Model->check_privilege( 'projects', 'all' ) ) { ?>
					{
				...
				<?php } if ( $this->Privileges_Model->check_privilege( 'tasks', 'own' ) || $this->Privileges_Model->check_privilege( 'tasks', 'all' ) ) { ?>
					{
						element: document.querySelector('.nav_left_menu > li.nav_left_icon_custom.ico-ciuis-tasks'),
						intro:  `<i class="tour ico-ciuis-tasks"></i>
						<img class="icon_close" src="<?= base_url('assets/img/tour/close.png'); ?>" onclick="introJs().exit();"><div class="top_container">
						<p class="title"><?= lang('x_menu_tasks'); ?></p>
						<p class="tour-description"><?= lang('manage_tasks'); ?></p></div>`,
						position: 'right',
					},
				<?php } if ( $this->Privileges_Model->check_privilege( 'tickets', 'own' ) || $this->Privileges_Model->check_privilege( 'tickets', 'all' ) ) { ?>
					{
				...
				<?php } if ( $this->Privileges_Model->check_privilege( 'expenses', 'own' ) || $this->Privileges_Model->check_privilege( 'expenses', 'all' ) ) { ?>
					{
						element: document.querySelector('.nav_left_menu > li.nav_left_icon_custom.ico-ciuis-expenses'),
						intro:  `<i class="tour ico-ciuis-expenses"></i>
						<img class="icon_close" src="<?= base_url('assets/img/tour/close.png'); ?>" onclick="introJs().exit();"><div class="top_container">
						<p class="title"><?= lang('x_menu_expenses'); ?></p>
						<p class="tour-description"><?= lang('manage_expenses'); ?></p></div>`,
						position: 'right',
					},
				<?php } if ( $this->Privileges_Model->check_privilege( 'deposits', 'own' ) || $this->Privileges_Model->check_privilege( 'deposits', 'all' ) ) { ?>
					{
						...
						<img class="icon_close" src="<?= base_url('assets/img/tour/close.png'); ?>" onclick="introJs().exit();"><div class="top_container">
						<p class="title"><?= lang('x_menu_deposits'); ?></p>
						<p class="tour-description"><?= lang('manage_deposits'); ?></p></div>`,
						position: 'right',
					},
				<?php } if ( $this->Privileges_Model->check_privilege( 'timesheets', 'own' ) || $this->Privileges_Model->check_privilege( 'timesheets', 'all' ) ) { ?>
					{
						element: document.querySelector('.nav_left_menu > li.nav_left_icon_custom.ion-ios-clock-outline'),
						intro:  `<i class="tour ion-ios-clock-outline"></i>
						<img class="icon_close" src="<?= base_url('assets/img/tour/close.png'); ?>" onclick="introJs().exit();"><div class="top_container">
						<p class="title"><?= lang('x_menu_timesheets'); ?></p>
						<p class="tour-description"><?= lang('manage_timesheets'); ?></p></div>`,
						position: 'right',
					},
				<?php } if ( isAdmin() ) { ?>
					{
						...
						<p class="title"><?= lang('settings'); ?></p>
						<p class="tour-description"><?= lang('manage').' '.lang('settings')?></p></div>`,
						position: 'right',
					},
				<?php }  ?>
				],
...
<script type="text/javascript">
	function update_tour_status() {
		angular.element(document.getElementById('tour_status')).scope().ChangeOnBoarding( '<?= $this->session->usr_id ?>', false );
	}
</script>
