...
<head>
  ...
  <script>
    var BASE_URL = "<?php echo base_url(); ?>",
      ...
      EVENTADDEDMSG = "<?php echo lang('eventadded') ?>",
      TODOADDEDMSG = "<?php echo lang('todoadded') ?>",
      TODODONEMSG = "<?php echo lang('tododone') ?>",
      REMINDERREAD = "<?php echo lang('remindermarkasread') ?>",
...
<body class="ciuis-body-splash-screen">
  <div class="ciuis-body-wrapper ciuis-body-login">
    <div class="ciuis-body-content">
      <div class="col-sm-4 login-left" style="background-image: url(<?php echo base_url('assets/img/images/' . $rebrand['admin_login_image'] . ''); ?>) !important;">
        <div class="lg-content">
          <h2><?php echo $rebrand['title'] ?></h2>
          <p class="text-muted"><?php echo $rebrand['admin_login_text'] ?></p>
          <div><p><a href="https://docs.ciuiscrm.com/hc/ciuiscrm" target="_blank" class="doc-style">Click here to see the documentation of CiusiCRM</a></p></div>
          <?php if ($rebrand['enable_client_area_button'] == '1') { ?>
            <a href="<?php echo base_url('area'); ?>">
              <md-button class="btn btn-warning md-raised md-warn p-l-20 p-r-20 client-button"><?php echo $rebrand['client_area_button_title'] ?></md-button>
            </a>
          <?php } ?>
        </div>
      </div>
      <div class="main-content container-fluid col-sm-8 login_page_right_block">
