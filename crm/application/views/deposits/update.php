    ...
    <md-content ng-show="!depositsLoader" class="bg-white" layout-padding ng-cloak>
      ...
      <div layout-gt-xs="row">
        ...
        <md-input-container class="md-block">
          ...
          <md-datepicker required name="created" ng-model="deposit.date_edit" md-date-locale="locale" md-open-on-focus></md-datepicker> 
      ...
      <div ng-show="deposit.recurring_status" layout-gt-xs="row">
        ...
        <md-input-container>
          ...
          <md-datepicker md-min-date="date" name="EndRecurring" ng-model="deposit.EndRecurring" md-date-locale="locale" style="min-width: 100%;" md-open-on-focus></md-datepicker>
          <div >
      ...
      <md-list-item ng-repeat="item in deposit.items">
        <div layout-gt-sm="row">
          ...
          <md-input-container class="md-block">
            ...
            <input  type = "number" min ="0" disabled="" ng-value="sub_val(item)">
          </md-input-container>
        </div>
