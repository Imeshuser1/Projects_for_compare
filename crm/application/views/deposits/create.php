  ...
  <div class="main-content container-fluid col-xs-12 col-md-12 col-lg-9">
    ...
    <md-toolbar ng-show="!depositsLoader" class="toolbar-white" ng-cloak>
      <div class="md-toolbar-tools">
        ...
        <h2 flex md-truncate><?php echo lang('new') . ' ' . lang('deposit') ?></h2>
    ...
    <md-content ng-show="!depositsLoader" class="bg-white" layout-padding ng-cloak>
      ...
      <div layout-gt-xs="row">
        ...
        <md-input-container>
          ...
          <md-datepicker required name="created" ng-model="newdeposit.date" md-date-locale="locale" md-open-on-focus></md-datepicker>
      ...
      <md-list-item ng-repeat="item in newdeposit.items">
        <div layout-gt-sm="row" class="total-line">
          ...
          <md-input-container class="md-block">
            ...
            <textarea class="min_input_width" ng-model="item.description" placeholder="<?php echo lang('description'); ?>" flex-gt-sm></textarea>
          ...
          <md-input-container class="md-block" flex-gt-sm>
            ...
            <input  type ="number" min="0"class="min_input_width" ng-model="item.quantity">
          </md-input-container>
          <md-input-container class="md-block" flex-gt-sm>
          ...
          <md-input-container class="md-block" flex-gt-xs>
            ...
            <input type ="number" min="1" class="min_input_width"ng-value ="item.tax" ng-model="item.tax">
