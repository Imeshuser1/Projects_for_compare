	...
	<div class="ciuis-body-content" ng-controller="Deposits_Controller">
						...
						<tbody md-body>
							<tr class="select_row" md-row ng-repeat="deposit in deposits | orderBy: deposit_list.order | limitTo: deposit_list.limit : (deposit_list.page -1) * deposit_list.limit | filter: deposit_search | filter: FilteredData" class="cursor" ng-click="goToLink('deposits/deposit/'+deposit.id)">
								<td md-cell>
									...
									<small ng-show="table_columns.title" ng-bind="deposit.title"></small>
								</td>
								...
								<td ng-show="table_columns.category" md-cell>
									<strong><span class="badge" ng-bind="deposit.category"></span></strong>
								</td>
								<td ng-show="table_columns.customer" md-cell>
									<strong><span ng-bind="deposit.customer"></span></strong>
								</td>
								<td ng-show="table_columns.staff" md-cell>
									<strong><span ng-bind="deposit.staff"></span></strong>
								</td>
	  ...
	  <md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="ContentFilter"  ng-cloak style="width: 450px;">
	    ...
	    <md-content layout-padding="">
	      <div ng-repeat="(prop, ignoredValue) in deposits[0]" ng-init="filter[prop]={}" ng-if="prop != 'id' && prop != 'title' && prop != 'prefix' && prop != 'longid' && prop != 'amount' && prop != 'staff' && prop != 'color' && prop != 'displayinvoice' && prop != 'date' && prop != 'category' && prop != 'billstatus' && prop != 'staff' && prop != 'customer'" ng-cloak>
