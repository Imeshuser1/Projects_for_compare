			...
			<div class="page-header row">
				...
				<div class="col-md-5 col-sm-5 col-xs-5">
					<small class="" style="position:relative;top:20px;right:20px;padding-right: 40px;text-align: left;float: right;">
						<strong><span class="text-uppercase font"><?php echo lang('deposit') ?></span> <!--  Deposit Title in your language -->
							# <?php echo ''.$number.'' ?> <!-- Deposit number -->
							<br>
							<span class="font"><?php echo '' . lang( 'deposit' ) .' '.lang( 'date' ). ': ' . date(get_dateFormat(), strtotime($deposit['date'])) . '' ?></span>
			...
			<div class="col-md-12 nav panel" style="padding-bottom: 20px;box-shadow: unset;padding-right: 0;">
				<?php if ($deposit[ 'deposit_status' ] == '2') { ?> 
					<div style="border-bottom: 1px solid #eee;padding-bottom: 10px;">
						<strong class="font"><?php echo lang('internal'). ' '.lang('deposit') ?></strong>
					</div>
					<div class="col-md-6 col-sm-6 col-xs-6" style="padding: 0">
				<?php } else { ?>
				<div style="border-bottom: 1px solid #eee;padding-bottom: 10px;">
					<!-- Customer Details -->
					<strong class="font"><?php echo lang('customer').' '.lang('deposit') ?></strong>
				</div>
				<div class="col-md-6 col-sm-6 col-xs-6" style="padding: 0">
					<br>
					<small>
					...
					<small>
						<strong class="font"><?php echo (($deposit[ 'taxnumber' ] == 0 || !$deposit[ 'taxnumber' ]) ? '': ($appconfig['tax_label'].' '.lang('vatnumber').': '.$deposit[ 'taxnumber' ]))  ?></strong>
					</small>
				</div>
			<?php } ?><br>
			</div>
				...
				<div class="col-md-6 col-xs-6 col-sm-6 panel pull-left" style="padding: 0;padding: 0;border: 1px solid #90909045;border-radius: 4px;width: 55%;page-break-inside: avoid;">
					...
					<table class="table" style="page-break-inside: avoid;">
						<thead style="">
							<tr>
								<!-- Account Type -->
								<th class="col-md-12 font"><?php echo  $deposit['account'] ?></th>
							</tr>
						</thead>
					</table>
				</div>
