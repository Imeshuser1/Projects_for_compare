...
<aside ng-controller="Sidebar_Controller" class="page-aside hidden-md hidden-sm hidden-xs ciuis-sag-sidebar-xs">
	<div id="events">
		<div class="ciuis-1 col-xs-12 nopadding">
			...
			<div class="col-xs-6 date-a"><?php $date = strtotime(date('y-m-d')); echo date(get_dateFormat(), $date).'<br/>'. lang(strtolower(date('l',$date))); ?> </div>
		</div>
		<div class="row">
				...
				<ul class="ciuis-activity-timeline">
					<li ng-repeat="log in logs | limitTo: LogLimit" class="ciuis-activity-detail">
						...
						<div class="ciuis-activity-detail-body">
							...
							<div style="margin-right: 58px; border-radius: 3px; background: transparent; color: #2f3239; font-weight: 400;" class="pull-right label label-default logs">
