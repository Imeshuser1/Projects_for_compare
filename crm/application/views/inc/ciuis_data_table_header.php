...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/lib/intro.js/introjs.css'); ?>">
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/system/custom.css?v=') . get_css_file_ver('assets/system/custom.css', 1, 12); ?>">
</head>
<?php $settings = $this->Settings_Model->get_settings_ciuis();
?>
<body ng-controller="Ciuis_Controller">
    <?php include_once('assets/system/header.php'); ?>
    ...
    <md-toolbar class="toolbar-ciuis-top">
        <div class="md-toolbar-tools">
            ...
            <md-button ng-hide="ONLYADMIN != 'true'" class="md-icon-button" ng-href="{{appurl + 'settings'}}" aria-label="Settings" ng-cloak>
                ...
                <md-icon><i class="setting-tour ion-gear-a text-muted"></i></md-icon>
            </md-button>
    ...
    <header id="mainHeader" role="banner" class="hidden-xs">
        <nav role="navigation">
            ...
            <ul id="menu-vertical-menu icon" class="nav nav_left_menu">
                <?php foreach ($leftmenus as $leftmenu) { ?>
                    <?php if ($leftmenu['show_staff'] == '0') { ?>
                        <li class="nav_left_icon_custom material-icons <?php echo $leftmenu['icon'] ?>"><a href="<?php echo $leftmenu['url'] ?>"><?php echo $leftmenu['title'] ?></a></li>
                    <?php } ?>
                <?php } ?>
            </ul>
        </nav>
                    ...
                    <li class="" ng-repeat="time in timers">
                        <div layout="row" layout-wrap class="timer-section">
                            ...
                            <div class="text-right" flex-gt-xs="40" flex-xs="40" layout="row">
                                <div class="text-right" flex-gt-xs="90" flex-xs="90" ng-if="!time.end">
                                ...
                                <div class="text-right" flex-gt-xs="90" flex-xs="90" ng-if="time.end">
                                    <div style="display: inline-flex;">
                                        <md-icon>
                                            <md-tooltip md-direction="top" ng-bind='lang.stop_timer'></md-tooltip>
                                            <i class="ion-ios-play" ng-click="startTimer('resume', time.id)"></i>
                                            <md-tooltip md-direction="top" ng-bind='lang.start_timer'></md-tooltip>
                                        </md-icon>
                                    </div>                                    
                                </div>
        ...
        <md-content layout-padding="">
            <md-content layout-padding>
                ...
                <md-input-container class="md-block">
                    ...
                    <input mdc-datetime-picker="" date="true" format="{{DateTimeFormat}}" time="true" type="text" id="datetime" placeholder="{{lang.chooseadate}}" show-todays-date="" minutes="true" min-date="date" show-icon="true" ng-model="onsite_visit.start" class=" dtp-no-msclear dtp-input md-input">
                </md-input-container>
                <md-input-container class="md-block">
                    <label ng-bind='lang.end'></label>
                    <input mdc-datetime-picker="" date="true" format="{{DateTimeFormat}}" time="true" type="text" id="datetime" placeholder="{{lang.chooseadate}}" show-todays-date="" minutes="true" min-date="onsite_visit.start" show-icon="true" ng-model="onsite_visit.end" class=" dtp-no-msclear dtp-input md-input">
                </md-input-container>
                <md-input-container class="md-block">
    ...
    <md-sidenav class="md-sidenav-right md-whiteframe-5dp" md-component-id="searchNav" ng-cloak style="width: 450px;" md-disable-close-events style="width: 650px;" ng-cloak>
        ...
        <md-content><br>
            ...
            <section ng-show="searchInventory.length > 0">
                <md-subheader class="md-accent">
                    <span class="material-icons ion-ios-paper-outline search-icon pull-right"></span>
                    <?php echo lang('inventory'); ?>
                </md-subheader>
                <md-list layout-padding>
                    <md-list-item class="md-3-line search-item" ng-repeat="inventory in searchInventory">
                        <a href="{{appurl + 'inventories/inventory/' + inventory.inventory_id}}">
                            <div class="md-list-item-text">
                                <h4 class="blur5" ng-bind='inventory.inventory_number?(inventory.inventory_number):("<?php echo $appconfig['inventory_prefix'] . '' . '{{inventory.inventory_id}}' ?>")'>
                                </h4>
                                <p>
                                    <strong><?php echo lang('product'); ?>:</strong>
                                    <span>{{ inventory.productname | limitTo: 30 }}{{inventory.productname.length > 30 ? '...' : ''}}</span>
                                </p>
                            </div>
                        </a>
                        <md-divider inset></md-divider>
        ...
        <md-content>
            <md-tabs md-dynamic-height md-border-bottom>
                <md-tab label="Profile">
                    ...
                    <?php } ?>
                            <md-switch ng-model="user.tour_status" id="tour_status" ng-change="ChangeOnBoarding(user.id,user.tour_status)" aria-label="Status"><strong class="text-muted" ng-bind='lang.turn_on_onboarding'></strong></md-switch>
                    </md-content>
                    <md-tabs>
                        <?php if (!$this->session->userdata('other')) { ?>
                                ...
                                <md-list class="md-dense" flex>
                                    <md-list-item class="md-3-line" ng-repeat="meet in meetings">
                                        <div class="md-list-item-text" layout="column">
                                            ...
                                            <p>
                                                <span ng-bind="meet.date"></span><br>
                                    ...
                                    <md-list class="md-dense" flex>
                                        <md-list-item class="md-3-line" ng-repeat="appointment in dashboard_appointments">
                                            ...
                                            <div class="md-list-item-text" layout="column">
                                                ...
                                                <p>
                                                    <span ng-bind="appointment.start_iso_date"></span><br>
