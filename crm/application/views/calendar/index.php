        ...
        <div layout="row" layout-wrap>
          <div flex-gt-xs="50" flex-xs="50">
            <md-input-container class="md-block">
              ...
              <input mdc-datetime-picker="" date="true" format="{{DateTimeFormat}}" time="true" type="text" id="datetime" placeholder="<?php echo lang('event') . ' ' . lang('start') ?>" show-todays-date="" minutes="true" min-date="date" show-icon="true" ng-model="event_start" class=" dtp-no-msclear dtp-input md-input" ng-init="event_start=date">
            </md-input-container>
          </div>
          <div flex-gt-xs="50" flex-xs="50">
            <md-input-container class="md-block">
              <label><?php echo lang('event') . ' ' . lang('end') ?></label>
              <input mdc-datetime-picker="" date="true" format="{{DateTimeFormat}}" time="true" type="text" id="datetime" minutes="true" min-date="event_start" show-icon="true" ng-model="event_end" class="dtp-no-msclear dtp-input md-input" placeholder="<?php echo lang('event') . ' ' . lang('end') ?>">
            </md-input-container>
          </div>
        </div>
        <md-input-container class="md-block">
