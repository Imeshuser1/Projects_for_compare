...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/lib/intro.js/introjs.css'); ?>">
   	...
   	switch ($this->session->is_admin) {case 0:$isAdmin = 'false';break;case 1:$isAdmin = 'true';break;}?>
   	<script>
   		var BASE_URL = "<?php echo base_url(); ?>";
   		var ACTIVESTAFF = "<?php echo $this->session->logged_in ?>";
   		var ISADMIN = "<?php echo $isAdmin ?>";
   		var HAS_MENU_PERMISSION = "false";
   		var SHOW_ONLY_ADMIN = "false";
   		var ACTIVE_CONTACT_NAME = "<?php echo $this->session->name ?> <?php echo $this->session->surname ?>";
         var TOUR_STATUS = "<?= $this->session->cust_tour_status ?>";
   	</script>
   	...
   	<md-toolbar class="toolbar-ciuis-top"> 
   		<div class="md-toolbar-tools">
   			...
   			<md-button ng-click="Appointment()" class="md-icon-button" aria-label="Appointment" ng-cloak>
   				...
   				<md-icon><i class="setting-tour ion-plus-round text-muted"></i></md-icon>
   			</md-button>
   			...
   			<div ng-click="Profile()" md-truncate class="user-informations hidden-xs" ng-cloak>
   				<span class="user-name-in"><?php echo $this->session->name ?> <?php echo $this->session->surname ?></span><br>
      ...
      <header id="mainHeader" role="banner" class="hidden-xs" ng-cloak>
         <nav role="navigation">
            ...
            <ul id="menu-vertical-menu icon" class="nav nav_left_menu">
               <li ng-repeat="menu in areamenu" class="nav_left_icon_custom material-icons {{menu.icon}}" ng-if="menu.show_staff == '0'"><a href="{{menu.url}}">{{menu.title}}</a></li>
            </ul>
         </nav>
      </header>
   	<!-- <header id="mainHeader" role="banner" class="hidden-xs" ng-cloak>
   	...
   	<md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="Profile"  ng-cloak style="width: 450px;">
         <md-toolbar class="toolbar-white">
   		...
   		<md-content class="text-center">
   			<md-content layout-padding class="md-mt-20" style="line-height: 0px;">
   				...
   				<h3><strong><?php echo $this->session->name; ?> <?php echo $this->session->surname ?></strong></h3><br>
         ...
         <md-content layout-padding>
            <md-switch ng-model="cust_tour_status" id="cust_tour_status" ng-change="ChangeOnBoarding(cust_tour_status)" aria-label="Status">
               <strong class="text-muted"><?= lang('turn_on_onboarding'); ?></strong>
            </md-switch>
         </md-content>
   	</md-sidenav>
   	<!-- Appointment -->
