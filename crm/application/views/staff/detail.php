          ...
          <div class="md-toolbar-tools">
            ...
            <md-menu md-position-mode="target-right target" ng-cloak>
              ...
              <md-menu-content width="4">
                <?php if (check_privilege('staff', 'edit')) { ?>
                  <md-menu-item>
                    <md-button ng-click="ChangePasswordAdmin()">
                      <div layout="row" flex>
                        <p flex><?php echo lang('changepassword') ?></p>
                        <md-icon md-menu-align-target class="ion-locked"></md-icon>
                      </div>
                    </md-button>
                  </md-menu-item>
                  <md-menu-item>
                    <md-button ng-click="ChangeAvatar()">
                      <div layout="row" flex>
                        ...
                        <md-icon md-menu-align-target class="ion-android-camera"></md-icon>
                      </div>
                    </md-button>
                  </md-menu-item>
                <?php }else { ?>
                  ...
                  <md-menu-item>
                    <md-button ng-click="Delete()">
                      <div layout="row" flex>
                        ...
                        <md-icon md-menu-align-target class="ion-trash-b delete-bin"></md-icon>
                      </div>
                    </md-button>
                  </md-menu-item>
                <?php }?>
...
<script type="text/ng-template" id="change-password.html">
  ...
  <md-dialog-content layout-padding>
    ...
    <md-input-container class="md-block">
      ...
      <input type="password" required ng-model="bpassword.old">
    </md-input-container>
    <md-input-container class="md-block">
      <label><?php echo lang('new').' '.lang('password') ?></label>
      <input type="password" required ng-model="bpassword.newpassword">
    </md-input-container>
    <md-input-container class="md-block">
      <label><?php echo lang('confirm').' '.lang('new').' '.lang('password') ?></label>
      <input type="password" required ng-model="bpassword.c_newpassword">
    </md-input-container>
    </md-content>
  </md-dialog-content>
  <md-dialog-actions>
