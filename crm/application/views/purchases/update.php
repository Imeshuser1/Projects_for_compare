		...
		<md-toolbar class="toolbar-white">
			<div class="md-toolbar-tools">
				...
				<md-button ng-href="<?php echo base_url('purchases/purchase/{{purchase.id}}')?>" class="md-icon-button" aria-label="View" ng-cloak>
					<md-tooltip column-definition="" md-direction="bottom"><?php echo lang('view') ?></md-tooltip>
				...
				<md-button ng-href="<?php echo base_url('purchases/purchase/{{purchase.id}}')?>" class="md-icon-button" aria-label="Cancel" ng-cloak>
					<md-tooltip column-definition="" md-direction="bottom"><?php echo lang('cancel') ?></md-tooltip>
				...
				<?php if (check_privilege('purchases', 'edit')) { ?>
					<md-button ng-click="saveAll()" class="md-icon-button" aria-label="Save" ng-cloak>
						<md-tooltip column-definition="" md-direction="bottom"><?php echo lang('save') ?></md-tooltip>
		...
		<md-content ng-show="!purchaseLoader" class="bg-white" layout-padding ng-cloak>
			<div layout-gt-xs="row">
				...
				<md-input-container>
					...
					<md-datepicker name="created" ng-model="purchase.created_edit" md-date-locale="locale" md-open-on-focus></md-datepicker>
				</md-input-container>
			</div>
			...
			<div ng-show="purchase.recurring_status" layout-gt-xs="row">
				...
				<md-input-container class="md-block" flex-gt-xs>
					...
					<input type ="number" ng-model="purchase.recurring_period" name="recurring_period" min="1">
				</md-input-container>
				<md-input-container class="md-block" flex-gt-xs>
				...
				<md-input-container>
					...
					<md-datepicker name="end_recurring" ng-model="purchase.end_recurring" md-date-locale="locale" md-open-on-focus></md-datepicker>
					<div >
			...
			<div ng-show="!purchase_status" layout-gt-xs="row">
				...
				<md-input-container>
					...
					<md-datepicker name="duedate" ng-model="purchase.duedate_edit" md-date-locale="locale" md-open-on-focus></md-datepicker>
				</md-input-container>
			</div>
		</md-content>
		<md-content ng-show="!purchaseLoader" class="bg-white" layout-padding ng-cloak>
			<md-list-item ng-repeat="item in purchase.items">
				<div layout-gt-sm="row">
					...
					<md-input-container class="md-block" flex-gt-sm>
						...
						<input type="number" class="min_input_width"  ng-value="item.discount" ng-model="item.discount" style="min-width: 25px !important;">
					</md-input-container>
					<md-input-container class="md-block" flex-gt-sm>
						<label><?php echo lang('total'); ?></label>
						<input type="number" min="0"  class="min_input_width" readonly=""  ng-value="sub_val(item)"/>
					</md-input-container>
				</div>
	...
	<md-toolbar class="toolbar-white">
		<div class="md-toolbar-tools">
			...
			<md-button ng-hide="purchase.partial_is != 'true'" class="md-icon-button" aria-label="Partial" ng-cloak>
				<md-tooltip column-definition="" md-direction="bottom"><?php echo lang('partial') ?></md-tooltip>
			...
			<md-button ng-hide="purchase.balance != 0" class="md-icon-button" aria-label="Paid" ng-cloak>
				<md-tooltip column-definition="" md-direction="bottom"><?php echo lang('paid') ?></md-tooltip>
	...
	<md-toolbar class="toolbar-white">
		<div class="md-toolbar-tools">
			...
			<md-button ng-show="purchase.balance != 0" ng-click="RecordPayment()" class="md-icon-button" aria-label="Record Payment" ng-cloak>
				<md-tooltip column-definition="" md-direction="left"><?php echo lang('recordpayment') ?></md-tooltip>
		...
		<form name="projectForm">
			<md-content layout-padding>
				...
				<div class="form-group pull-right">
					<md-button ng-click="AddPayment(projectForm)" class="md-raised md-primary ion-ios-paperplane" type="button">
