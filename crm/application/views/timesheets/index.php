          ...
          <md-list flex>
            ...
            <md-list-item>
              <md-input-container class="md-block full-width">
                ...
                <input mdc-datetime-picker="" date="true" format="{{DateTimeFormat}}" time="true" type="text" id="datetime" placeholder="<?php echo lang('chooseadate') ?>" show-todays-date="" minutes="true" show-icon="true" ng-model="logtime.start_time" class=" dtp-no-msclear dtp-input md-input">
              </md-input-container>
            </md-list-item>
            <md-list-item>
              <md-input-container  class="md-block full-width">
                <label><strong><?php echo lang('end_time') ?></strong></label>
                <input mdc-datetime-picker="" date="true" format="{{DateTimeFormat}}" time="true" type="text" id="datetime" placeholder="<?php echo lang('chooseadate') ?>" show-todays-date="" minutes="true" min-date="logtime.start_time" show-icon="true" ng-model="logtime.end_time" class=" dtp-no-msclear dtp-input md-input">
              </md-input-container>
            </md-list-item>
            <md-list-item>
              <md-input-container  class="md-block full-width">
        ...
        <md-content class="bg-white">
          <md-list flex>
            ...
            <md-list-item>
              <md-input-container class="md-block full-width">
                <label><?php echo lang('start_time'); ?></label>
                <input mdc-datetime-picker="" date="true" format="{{DateTimeFormat}}" time="true" type="text" id="datetime" placeholder="<?php echo lang('chooseadate') ?>" show-todays-date="" minutes="true" show-icon="true" ng-model="updatetimer.start_time" class=" dtp-no-msclear dtp-input md-input">
              </md-input-container>
            </md-list-item>
            <md-list-item>
              <md-input-container  class="md-block full-width">
                <label><strong><?php echo lang('end_time') ?></strong></label>
                <input mdc-datetime-picker="" date="true" format="{{DateTimeFormat}}" time="true" type="text" id="datetime" placeholder="<?php echo lang('chooseadate') ?>" show-todays-date="" minutes="true" min-date="updatetimer.start_time" show-icon="true" ng-model="updatetimer.end_time" class=" dtp-no-msclear dtp-input md-input">
              </md-input-container>
            </md-list-item>
            <md-list-item>
              <md-input-container  class="md-block full-width">
