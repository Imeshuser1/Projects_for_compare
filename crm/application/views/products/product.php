        ...
        <md-content class="bg-white" flex-gt-xs="50" flex-xs="100" style="border-right:1px solid #e0e0e0;">
          <md-list flex class="md-p-0 sm-p-0 lg-p-0">
            <md-list-item>
              ...
              <p class="text-right" flex md-truncate ng-bind="product.warehouse_name"></p>
            </md-list-item>
            <md-divider></md-divider>
            <md-list-item>
              <md-icon class="ion-pricetags icon"></md-icon>
              <strong flex md-truncate><?php echo lang('uom') ?></strong>
              <p class="text-right" flex md-truncate ng-bind="product.unit_measure"></p>
            ...
            <md-list-item>
              ...
              <p class="text-right" flex md-truncate ng-bind="product.product_type"></p>
            </md-list-item>
            <md-divider></md-divider>
            <md-list-item>
    ...
    <md-content>
      <md-content layout-padding>
        ...
        <md-input-container class="md-block">
          ...
          <md-select placeholder="<?php echo lang('uom'); ?>" ng-model="product.unit_id" style="min-width: 200px;">
        ...
        <md-input-container class="md-block">
          ...
          <md-select placeholder="<?php echo lang('warehouse'); ?>" ng-model="product.warehouse_id" style="min-width: 200px;">
      ...
      <md-content layout-padding>
        <section layout="row" layout-sm="column" layout-align="center center" layout-wrap>
          <md-button ng-click="UpdateProduct()" class="md-raised md-primary pull-right block-button"><?php echo lang('update');?></md-button>
        </section>
      </md-content>
    </md-content>
  </md-sidenav>
