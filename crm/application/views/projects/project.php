                ...
                <li ng-repeat="milestone in milestones" class="milestone_project-milestone {{milestone.status}}">
                  <div class="milestone_project-action is-expandable expanded expensesSection">
                    <div class="pull-right">
                      <md-button aria-label="Remove Milestone" class="md-icon-button" ng-click="RemoveMilestone($index)" ng-disabled="loadingMilestones">
                        <md-icon><i class="ion-trash-b text-muted"></i></md-icon>
                      </md-button>
                      <md-button aria-label="Show Milestone" class="md-icon-button" ng-click="ShowMilestone($index)" ng-disabled="loadingMilestones">
                        <md-icon><i class="ion-ios-compose text-muted"></i></md-icon>
                      </md-button>
                    </div>
                    <h2 class="milestonetitle" ng-bind="milestone.name"></h2>
                    <span class="milestonedate exp" ng-bind="milestone.due"></span>
                    <div class="content">
    ...
    <md-content>
      <md-content layout-padding>
        ...
        <md-input-container>
          ...
          <md-datepicker name="start" ng-model="project.start_edit" md-date-locale="locale" md-open-on-focus></md-datepicker>
        </md-input-container>
        <md-input-container>
          <label><?php echo lang('deadline') ?></label>
          <md-datepicker md-min-date="project.start_edit" name="deadline_edit" ng-model="project.deadline_edit" md-date-locale="locale" md-open-on-focus></md-datepicker>
        </md-input-container>
        <md-input-container class="md-block">
    ...
    <md-content layout-padding="">
      <md-content layout-padding>
        ...
        <md-input-container class="md-block">
          ...
          <input mdc-datetime-picker="" date="true" time="true" format="{{DateTimeFormat}}" type="text" id="datetime" placeholder="<?php echo lang('chooseadate') ?>" show-todays-date="" minutes="true" show-icon="true" ng-model="amilestone.duedate" class=" dtp-no-msclear dtp-input md-input">
        </md-input-container>
        <md-input-container class="md-block">
          <label><?php echo lang('description') ?></label>
  ...
  <md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="NewTask" ng-cloak style="width: 450px;">
    ...
    <md-content layout-padding="">
      <md-content layout-padding>
        ...
        <md-input-container class="md-block">
          <label><?php echo lang('startdate') ?></label>
          <md-datepicker md-min-date="date" name="start" ng-model="newtask.startdate" md-date-locale="locale" md-open-on-focus></md-datepicker>
        </md-input-container>
        <md-input-container class="md-block">
          <label><?php echo lang('duedate') ?></label>
          <md-datepicker md-min-date="date" name="start" ng-model="newtask.duedate" md-date-locale="locale" md-open-on-focus></md-datepicker>
        </md-input-container>
    ...
    <md-content layout-padding="">
      <md-content layout-padding>
        ...
        <md-input-container class="md-block">
          ...
          <!-- "min-date" is taken out so the date selection range is avaiable from the past year or months for creating expenses from past-->
          <input mdc-datetime-picker="" date="true" format="{{DateTimeFormat}}" time="true" type="text" id="datetime" placeholder="<?= lang('chooseadate') ?>" show-todays-date="" minutes="true" show-icon="true" ng-model="newexpense.date" class=" dtp-no-msclear dtp-input md-input">
        </md-input-container>
        <md-input-container class="md-block" flex-gt-xs>
        ...
        <input required type="text" ng-model="ticket.subject" name="subject" class="form-control">
          ...
          <md-input-container ng-show="project.template == 0" class="md-block" flex-gt-xs>
            ...
            <md-select disabled placeholder="<?php echo lang('choisecustomer'); ?>" ng-model="ticket.customer" name="customer" ng-init="project.customer_id">
              <md-option ng-value="customer.id" ng-repeat="customer in all_customers" ng-selected="customer.id == project.customer_id">{{customer.name}}</md-option>
            </md-select>
            <br>
          </md-input-container>
          <md-input-container class="md-block" flex-gt-xs>
              ...
              <md-select-header>
                <md-toolbar class="toolbar-white">
                  <div class="md-toolbar-tools">
                    ...
                    <md-button class="md-icon-button" ng-href="<?php echo base_url('customers/customer/{{project.customer_id}}')?>" target="_blank" aria-label="Create New">
                      <md-icon><i class="mdi mdi-plus text-muted"></i></md-icon>
                    </md-button>
                  </div>
                </md-toolbar>
              </md-select-header>
              <md-option ng-value="contact.id" ng-repeat="contact in project.customercontact">{{contact.name + ' ' + contact.surname}}</md-option>
            </md-select><br>
          </md-input-container>
          <md-input-container class="md-block" flex-gt-xs>
          ...
          <div class="ciuis-ticket-row">
            ...
            <div class="ciuis-ticket-fieldgroup">
              ...
              <div class="ticket-data">
                <a href="<?php echo base_url('customers/customer/{{project.customer_id}}')?>" ng-bind="ticket.customername"></a>
              </div>
            </div>
          </div>
          <div class="ciuis-ticket-row">
    ...
    <md-content ng-show="newProposal" class="bg-white" layout-padding>
      <div layout-gt-xs="row">
        ...
        <md-input-container>
          ...
          <md-datepicker name="created" ng-model="newproposal.created" md-date-locale="locale" md-open-on-focus></md-datepicker>
        </md-input-container>
        <md-input-container>
          <label><?php echo lang('opentill') ?></label>
          <md-datepicker md-min-date="created" name="opentill" ng-model="newproposal.opentill" md-date-locale="locale" md-open-on-focus></md-datepicker>
        </md-input-container>
      </div>
      <div layout-gt-xs="row">
        <md-input-container class="md-block" flex-gt-xs>
        ...
        <form>
          ...
          <md-dialog-content style="max-width:800px;max-height:810px; ">
            <md-content class="bg-white" layout-padding>
              ...
              <md-input-container class="md-block">
                <label><?php echo lang('duedate') ?></label>
                <input mdc-datetime-picker="" date="true" format="{{DateTimeFormat}}" time="true" type="text" id="datetime" placeholder="<?php echo lang('chooseadate') ?>" show-todays-date="" minutes="true" show-icon="true" ng-model="milestone.duedate" class=" dtp-no-msclear dtp-input md-input">
              </md-input-container>
              <md-input-container class="md-block">
                <label><?php echo lang('description') ?></label>
