    ...
    <md-toolbar class="toolbar-white" style="margin-bottom: 1%;">
      <div class="md-toolbar-tools">
        ...
        <div class="ciuis-external-search-in-table" ng-cloak>
          <input ng-model="search" class="search-table-external" id="search" name="search" type="text" placeholder="<?php echo lang('search_by').' '.lang('project').' '.lang('name')?>">
    ...
    <md-content>
      <md-content layout-padding>
        ...
        <md-input-container>
          ...
          <md-datepicker name="start" ng-model="project.start" md-date-locale="locale" md-open-on-focus></md-datepicker>
        </md-input-container>
        <md-input-container>
          <label><?php echo lang('deadline') ?></label>
          <md-datepicker md-min-date="project.start" name="deadline" ng-model="project.deadline" md-date-locale="locale" md-open-on-focus></md-datepicker>
        </md-input-container>
        <md-input-container class="md-block">
          ...
          <md-list flex>
            <md-list-item>
              <div class="ciuis-custom-list-item-item col-md-12">
                  ...
                  <div class="col-md-6 md-block">
                    <md-input-container class="md-block" flex-gt-xs>
                      ...
                      <md-select required placeholder="<?php echo lang('choisecustomer'); ?>" ng-model="copy.customer" name="customer" style="min-width: 200px;">
                        <md-option ng-value="customer.id" ng-repeat="customer in all_customer">{{customer.name}}</md-option>
                      </md-select>
                    </md-input-container>
                  </div>
                  <div class="col-md-6 md-block">
                ...
                <md-input-container>
                  <label><?php echo lang('startdate') ?></label>
                  <md-datepicker name="start" ng-model="copy.start" md-date-locale="locale" md-open-on-focus></md-datepicker>
                </md-input-container>
                <md-input-container>
                  <label><?php echo lang('deadline') ?></label>
                  <md-datepicker name="deadline" ng-model="copy.end" md-date-locale="locale" md-open-on-focus></md-datepicker>
                </md-input-container>
              </div>
            </md-list-item>
          </md-list>
