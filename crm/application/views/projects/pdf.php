		...
		<div class="row">
			<div class="page-header row">
				<div class="col-md-3 col-sm-3 col-xs-3 logo">
					...
					<small>
						<strong class="font"><?php echo ($settings['company']) ? $settings['company'] : ""	; ?></strong> <!-- Company Name from app settings -->
					</small><br>
					<small class="font" style="font-size: 11px;">
						<!-- Company Address -->
				...
				<div class="col-md-4 col-sm-4 col-xs-4" style="padding-top: 2%;text-align: center;">
					<strong class="section-title font"><span style="font-size: 25px;" class="text-uppercase"><?php echo lang('project') ?></span> <br>
					<!--  Project Title in your language -->
					</strong>
					<span class="section-title font">
						<!-- Project number -->
				...
				<div class="col-md-5 col-sm-5 col-xs-5">
					<small class="" style="position:relative;top:20px;right:20px;padding-right: 40px;text-align: left;float: right;">
						<strong><span class="text-uppercase font"><?php echo lang('project') ?></span> <br>
							<span class="font"><?php echo $project_number ?></span>
							<br> 
							<!-- Porject Start Date -->
							<span class="font"><?php echo lang( 'start' ). ' '.lang( 'date' ).': ' . date(get_dateFormat(), strtotime($project['start_date'])) ?></span>
							<br>
							<!-- Project Dead Line -->
							<span class="font"><?php echo lang( 'deadline' ).': ' . date(get_dateFormat(), strtotime($project['deadline'])) ?></span>
						</strong>
					</small>
				</div>
			</div>
			<div class="col-md-12 nav panel" style="padding-bottom: 20px;box-shadow: unset;padding-right: 0;">
				<div style="border-bottom: 1px solid #eee;padding-bottom: 10px;">
					<strong class="font"><?php echo $project['name'] ?></strong>
				</div>
				<?php if ($customer == true) { ?>
				<div class="col-md-6 col-sm-6 col-xs-6" style="padding: 0">
					<div class="section-title" style="border-bottom: 1px solid #eee;padding-bottom: 10px;">
						<!-- Customer Details -->
						<strong class="font"><?php echo lang('customer').' '.lang('details') ?></strong>
					</div>
					<br>
					<small>
						<strong class="font"><?php echo $project['customercompany']?$project['customercompany']:$project['individual']; ?></strong>
					</small><br>
					<small class="font">
					...
					<small>
						...
						<strong class="font"><?php echo  ($project[ 'taxoffice' ] ? $appconfig['tax_label'].' '.lang('taxoffice').': ' : '') ?></strong><span class="font"><?php echo $project[ 'taxoffice' ]; ?></span>
					</small><br>
					<small>
						<strong class="font"><?php echo (($project[ 'taxnumber' ] == 0 || !$project[ 'taxnumber' ]) ? '': ($appconfig['tax_label'].' '.lang('vatnumber').': '.$project[ 'taxnumber' ]))  ?></strong>
					</small>
				</div>
			<?php } ?>
				<div class="col-md-6 col-sm-6 col-xs-6" style="padding: 0">
					<div class="section-title" style="border-bottom: 1px solid #eee;padding-bottom: 10px;">
						<!-- Project Details -->
						<strong class="font"><?php echo lang('project').' '.lang('details') ?></strong>
					</div>
					<br>
					<small> 
						<?php $log_time = (int)0; 
						...
						<strong><span class="font"><?php echo lang('project').' '.lang('status').': '.$status ?></span><br>
						<span class="font"><?php echo lang('project').' '.lang('value').': '.$project['projectvalue'] ?></span><br>
						<span class="font"><?php echo lang('clocked').' '.lang('time').': '. floor($log_time / 60).'h : '.($log_time % 60).'m' ?></span><br>
						<span class="font"><?php echo lang('clocked').' '.lang('amount').': '.amount_format($log_amt, true) .''; ?></span><br></strong>
					</small><br>
				</div>
				<br>
			</div>
			...
			<div class="col-md-12 nav new-section">
				<div class="section-title font" style="padding: 10px;color: blue;">
				...
				<table class="table" style="box-shadow: 0 1px 1px rgb(255, 255, 255);margin-top: 1%;">
					<tbody>
						<tr style="border-bottom: 1px solid #eaeaea;">
							<td class="text-left col-md-3 font">
			...
			<div class="col-md-12 nav new-section">
				<div class="section-title" style="padding: 10px;color: blue;">
					<strong class="font"><?php echo lang('project').' '. lang('members') ?></strong>
				</div>
				<table class="table" style="box-shadow: 0 1px 1px rgb(255, 255, 255);margin-top: 1%;">
			...
			<div class="col-md-12 nav new-section">
				<div class="section-title" style="padding: 10px;color: blue;">
					<strong class="font"><?php echo lang('project').' '. lang('services') ?></strong>
				</div>
				<table class="table" style="box-shadow: 0 1px 1px rgb(255, 255, 255);margin-top: 1%;">
					<thead style="border-top: 2px solid #e4e4e4;">
						<tr>
							<th class="col-md-4 font">
							...
							<th class="col-md-2 font" style="text-align: center;">
					...
					<tbody>
						<?php if (count($services) > 0) {
							...
							<tr style="border-bottom: 1px solid #eaeaea;">
								...
								<td class="text-left font" style="text-align: center;">
			...
			<div class="col-md-12 nav new-section">
				<div class="section-title" style="padding: 10px;color: blue;">
					<strong class="font"><?php echo lang('project').' '. lang('milestones') ?></strong>
				</div>
			...
			<div class="col-md-12 nav new-section">
				<div class="section-title" style="padding: 10px;color: blue;">
					<strong class="font"><?php echo lang('project').' '. lang('tasks') ?></strong>
				</div>
				<table class="table" style="box-shadow: 0 1px 1px rgb(255, 255, 255);margin-top: 1%;">
					<thead style="border-top: 2px solid #e4e4e4;">
						<tr>
			...
			<div class="col-md-12 nav new-section">
				<div class="section-title" style="padding: 10px;color: blue;">
					<strong class="font"><?php echo lang('project').' '. lang('expenses') ?></strong>
				</div>
				<table class="table" style="box-shadow: 0 1px 1px rgb(255, 255, 255);margin-top: 1%;">
					<thead style="border-top: 2px solid #e4e4e4;">
						<tr>
			...
			<div class="col-md-12 nav new-section">
				<div class="section-title" style="padding: 10px;color: blue;">
					<strong class="font"><?php echo lang('project').' '. lang('proposals') ?></strong>
				</div>
				<table class="table" style="box-shadow: 0 1px 1px rgb(255, 255, 255);margin-top: 1%;">
					<thead style="border-top: 2px solid #e4e4e4;">
						<tr>
					...
					<tbody>
						...
						<?php } } else { 
							?> <tr style="border-bottom: 1px solid #eaeaea;"><span class="font"><?php
							echo lang('no').' '.lang('proposals').' '.lang('found'); ?></span>
						</tr> <?php } ?>
					</tbody>
				</table>
			</div>
			...
			<div class="col-md-12 nav new-section">
				<div class="section-title" style="padding: 10px;color: blue;">
					<strong class="font"><?php echo lang('project').' '. lang('tickets') ?></strong>
				</div>
				<table class="table" style="box-shadow: 0 1px 1px rgb(255, 255, 255);margin-top: 1%;">
					<thead style="border-top: 2px solid #e4e4e4;">
						<tr>
			...
			<div class="col-md-12 nav new-section">
				<div class="section-title" style="padding: 10px;color: blue;">
					<strong class="font"><?php echo lang('project').' '. lang('notes') ?></strong>
				</div>
				<table class="table" style="box-shadow: 0 1px 1px rgb(255, 255, 255);margin-top: 1%;">
					<thead style="border-top: 2px solid #e4e4e4;">
						<tr>
			...
			<div class="col-md-12 nav new-section">
				<div class="section-title" style="padding: 10px;color: blue;">
					<strong class="font"><?php echo lang('project').' '. lang('task').' '. lang('time_logs') ?></strong>
				</div>
				<table class="table" style="box-shadow: 0 1px 1px rgb(255, 255, 255);margin-top: 1%;">
					<thead style="border-top: 2px solid #e4e4e4;">
						<tr>
			...
			<div class="col-md-12 nav new-section">
				<div class="section-title" style="padding: 10px;color: blue;">
					<strong class="font"><?php echo lang('project').' '. lang('files') ?></strong>
				</div>
				<table class="table" style="box-shadow: 0 1px 1px rgb(255, 255, 255);margin-top: 1%;">
					<tbody>
