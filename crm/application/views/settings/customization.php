<md-content class="md-padding bg-white">
	...
	<div class="col-md-6">
		<div class="col-md-12 md-p-0 upload-logo">
			...
			<div layout="row" layout-wrap>
				<div flex-gt-xs="50" flex-xs="100">
					<div flex="100">
						<h2 class="md-title"><?php echo lang('email_banner'); ?></h2>
					</div>
					<div flex="100">
						<div>
							<img style="max-width: 50% !important" ng-src="<?php echo base_url('uploads/ciuis_settings/{{rebrand.email_banner}}')?>"
							on-error-src="<?php echo base_url('assets/img/placeholder.png')?>">
						</div>
						<span><?php echo lang('reommended_size'); ?> 600 x 258 px.</span>
						<div flex-gt-xs="50" flex-xs="100" class="file-upload">
							<input type="file" name="email_banner" class="file-type" accept="image/*"
	...
	<div class="col-md-6">
		...
		<md-input-container ng-show="rebrand.enable_client_area_button" class="md-block">
			<label><?php echo lang('clientarea').' '.lang('support_button_title')?></label>
			<input ng-model="rebrand.client_area_button_title" type="text" name="client_area_button_title">
		</md-input-container>
		...
		<md-input-container class="md-block" style="margin-top: unset;">
			<md-switch class="pull-left" ng-model="rebrand.enable_client_area_button" aria-label="Status" style="margin: unset;">
				<strong class="text-muted"><?php echo lang('clientarea').' '.lang('button') ?></strong>
			</md-switch>
		</md-input-container>
