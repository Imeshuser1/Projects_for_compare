 			...
 			<md-card-content>
 				...
 				<?php if (check_module_active('hrm') == true) { ?>
 					...
 					<div layout="row" layout-wrap>
 						<div flex-gt-xs="50" flex-xs="100">
 							<md-input-container class="md-block">
 								<label><?php echo lang('payroll') . ' ' . lang('prefix') ?></label>
 								<input ng-model="finance.payroll_prefix">
 							</md-input-container>
 						</div>
 						<div flex-gt-xs="50" flex-xs="100">
 							<md-input-container class="md-block">
 								<label><?php echo lang('payroll') . ' ' . lang('series') ?></label>
 								<input type="number" ng-model="finance.payroll_series">
 							</md-input-container>
 						</div>
 					</div>
 					<!-- Payslip -->
 					<div layout="row" layout-wrap>
 						<div flex-gt-xs="50" flex-xs="100">
 							<md-input-container class="md-block">
 								<label><?php echo lang('payslip') . ' ' . lang('prefix') ?></label>
 								<input ng-model="finance.payslip_prefix">
 							</md-input-container>
 						</div>
 						<div flex-gt-xs="50" flex-xs="100">
 							<md-input-container class="md-block">
 								<label><?php echo lang('payslip') . ' ' . lang('series') ?></label>
 								<input type="number" ng-model="finance.payslip_series">
 							</md-input-container>
 						</div>
 					</div>
 				<?php } ?>
 		...
 		<md-card layout="column" class="md-padding" style="margin-left: 1.8%;">
 			<md-card-content>
 				...
 				<div layout="row" layout-wrap>
 					<div flex-gt-xs="50" flex-xs="100">
 						<md-input-container class="md-block">
 							<label><?php echo lang('inventory').' '.lang('prefix')?></label>
 							<input required ng-model="finance.inventory_prefix">
 						</md-input-container>
 					</div>
 					<div flex-gt-xs="50" flex-xs="100">
 						<md-input-container class="md-block">
 							<label><?php echo lang('inventory').' '.lang('series')?></label>
 							<input type="number" ng-model="finance.inventory_series">
 						</md-input-container>
 					</div>
 				</div>
 				<!-- Warehouse -->
 				<div layout="row" layout-wrap>
 					<div flex-gt-xs="50" flex-xs="100">
 						<md-input-container class="md-block">
 							<label><?php echo lang('warehouse').' '.lang('prefix')?></label>
 							<input required ng-model="finance.warehouse_prefix">
 						</md-input-container>
 					</div>
 					<div flex-gt-xs="50" flex-xs="100">
 						<md-input-container class="md-block">
 							<label><?php echo lang('warehouse').' '.lang('series')?></label>
 							<input type="number" ng-model="finance.warehouse_series">
 						</md-input-container>
 					</div>
 				</div>
 			</md-card-content>
