<md-content class="md-padding bg-white">
	<div class="col-md-6">
		...
		<md-input-container class="md-block">
			...
			<md-select placeholder="<?php echo lang('country'); ?>" ng-model="settings_detail.country_id" ng-change="getStates(settings_detail.country_id)" style="min-width: 200px;">
		...
		<md-input-container class="md-block">
			...
			<md-select placeholder="<?php echo lang('state'); ?>" ng-model="settings_detail.state_id" name="state_id" style="min-width: 200px; margin: 6px;">
