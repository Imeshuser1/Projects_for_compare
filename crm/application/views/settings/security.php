<md-content class="md-padding bg-white">
	...
	<div class="col-md-6">
		...
		<div class="col-md-12 md-p-0">
			...
			<!--Error_reporting toggle-->
			<md-switch class="pull-left" ng-model="settings_detail.error_reporting" aria-label="Status"><strong class="text-muted"><?php echo lang('error_reporting') ?></strong></md-switch>
		</div>
	</div>
</md-content>