    ...
    <md-content class="bg-white" layout-padding ng-cloak>
      <div layout-gt-xs="row">
        ...
        <md-input-container>
          ...
          <md-datepicker name="created" ng-model="proposal.date_edit" md-date-locale="locale" md-open-on-focus></md-datepicker>
        </md-input-container>
      </div>
      <div layout-gt-xs="row">
        ...
        <md-input-container>
          ...
          <md-datepicker md-min-date="proposal.date_edit" name="opentill" md-date-locale="locale" ng-model="proposal.opentill_edit" md-open-on-focus></md-datepicker>
        </md-input-container>
      </div>
      <div layout-gt-xs="row">
        <md-input-container class="md-block" flex-gt-xs>
      ...
      <md-list-item ng-repeat="item in proposal.items">
        <div layout-gt-sm="row">
          ...
          <md-input-container class="md-block" flex-gt-xs>
            ...
            <input type = "number" min ="1" class="min_input_width" ng-model="item.discount">
          </md-input-container>
          <md-input-container class="md-block">
