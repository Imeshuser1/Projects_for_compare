  ...
  <div class="main-content container-fluid col-md-9 borderten">
    <md-toolbar class="toolbar-white">
      <div class="md-toolbar-tools">
        ...
        <md-menu ng-show="!proposal.proposal_type" md-position-mode="target-right target">
          ...
          <md-menu md-position-mode="target-right target">
            ...
            <md-menu-content width="4">
              ...
              <?php if (check_privilege('proposals', 'edit')) { ?> 
                <md-menu-item>
                <!-- sent expriration-->
                <md-button ng-click="expiration(proposal.id)" ng-bind="lang.sentexpirationreminder"
              ...
              <main>
                ...
                <div ng-show="proposal.is_requested == '1'" class="col-md-6">
                  <strong><?php echo lang('details') ?>:<br></strong>
                    <pre class="pre_view" ng-cloak>{{proposal.content}}</pre> 
                  <br>
                  <br>
                </div>
                <div ng-show="proposal.is_requested == '1'" class="col-md-6">
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tbody>
                    <tr ng-repeat="item in proposal.items">
                      ...
                      <td class="qty text-right" ng-bind="item.unit"></td>
