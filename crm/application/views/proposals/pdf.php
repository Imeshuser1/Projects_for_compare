	...
	<div class="container">
		<div class="row">
			<div class="page-header">
				...
				<small class="pull-right" style="position:relative;top:20px;right:20px;"><strong><span class="text-uppercase font"><?php echo lang('proposal') ?></span> <br> <!--  Proposal Title in your language -->
					#<?php echo '' . $number. '' ?> <!-- Proposal number -->
					<br> <span class="font"><?php echo lang( 'date' ).': '. //Date label 
					date(get_dateFormat(), strtotime($proposals['date']))?></span> - <span class="font"><?php echo lang( 'opentill' )?></span> : <?php echo date(get_dateFormat(), strtotime($proposals['opentill']))?>
			...
			<div class="col-md-12 nav panel" style="padding-bottom: 20px">
				<div class="col-md-6 col-sm-6 col-xs-6" style="padding: 0">
					...
					<small>
						...
						<strong class="font"><?php echo  ($settings[ 'taxoffice' ] ? $appconfig['tax_label'].' '.lang('taxoffice').':' : '') ?></strong><span class="font"><?php echo $settings[ 'taxoffice' ]; ?></span>
					</small><br>
					<small class="font">
