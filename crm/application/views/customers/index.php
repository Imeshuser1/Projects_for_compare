        ...
        <table md-table md-progress="promise">
          <thead md-head md-order="customer_list.order">
            <tr md-row>
              ...
              <th ng-show="table_columns.name" md-column md-order-by="name"><span><?php echo lang('name'); ?></span></th>
              <th ng-show="table_columns.group" md-column md-order-by="group"><span><?php echo lang('group'); ?></span></th>
    ...
    <md-content>
      <md-content layout-padding>
        ...
        <md-input-container class="md-block">
          ...
          <input ng-model="customer.phone" required ng-pattern="/^[-+() \d]+$/" ng-keyup="showPhoneError($event)">
          <p ng-show="!customer.phone" style="color: red" id="phoneError" hidden><?=lang('phone_required')?></p>
        </md-input-container>
        <md-input-container class="md-block">
        ...
        <div class="filter col-md-12">
          ...
          <div ng-if="prop=='<?php echo lang('filterbycountry') ?>'">
            ...
            <md-select aria-label="Filter" ng-model="filter_select" ng-init="filter_select='all'" >
              ...
              <md-option ng-repeat="opt in countries" ng-click="updateDropdown(opt.countryID)" value="{{opt.countryID}}">{{opt.countryName}}</md-option>
            </md-select>
          </div>
        </div>
      </div>
