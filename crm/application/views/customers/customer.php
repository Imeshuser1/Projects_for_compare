                    ...
                    <md-tab label="<?php echo lang('customeractivities');?>">
                        <md-content class="md-padding bg-white">
                            <ul class="user-timeline">
                                <li ng-repeat="log_customer in customer.customer_logs">
                                    <div class="user-timeline-title" ng-bind="log_customer.date"></div>
                                    <div class="user-timeline-description" ng-bind-html="log_customer.detail|trustAsHtml"></div>
                                </li>
                            </ul>
                        </md-content>
                    </md-tab>
        ...
        <md-content layout-padding="">
            <md-content layout-padding>
                <md-input-container class="md-block">
                    ...
                    <input mdc-datetime-picker="" date="true" format="{{DateTimeFormat}}" time="true" type="text" id="datetime"
        ...
        <div class="md-toolbar-tools">
            ...
            <md-content layout-padding>
                ...
                <md-input-container class="md-block">
                    ...
                    <input name="phone" ng-model="customer.phone" required ng-pattern="/^[-+() \d]+$/">
                    <p ng-show="!customer.phone && customer.phone.length != 0" style="color: red"><?=lang('phone_required')?></p>
                </md-input-container>
                <md-input-container class="md-block">
