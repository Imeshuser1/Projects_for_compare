...
$file_path_error = getcwd() . '../error_off.php';
define('ENVIRONMENT', isset($_SERVER['CI_ENV']) ? $_SERVER['CI_ENV'] : 'development');
if (is_file($file_path_error)) {
	include_once($file_path_error);
}
!defined('ENVIRONMENT_VALUE') && define('ENVIRONMENT_VALUE', E_ALL);
//changed here from E_ALL and ENVIRONMENT_VALUE
error_reporting(ENVIRONMENT_VALUE);
// session start
...
define('DB_FILE_PATH',         '../../public/files/Load_data.sql');  
